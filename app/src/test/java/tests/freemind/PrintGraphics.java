...
public class PrintGraphics extends Graphics2D {
  ...
  public void drawRoundRect(
      int pX, int pY, int pWidth, int pHeight, int pArcWidth, int pArcHeight) {
  ...
  public boolean drawImage(
      Image pImg, int pX, int pY, int pWidth, int pHeight, ImageObserver pObserver) {
  ...
  public boolean drawImage(
      ...
      Color pBgcolor,
      ImageObserver pObserver) {
    return mG.drawImage(pImg, pDx1, pDy1, pDx2, pDy2, pSx1, pSy1, pSx2, pSy2, pBgcolor, pObserver);
  }
