...
public class PrintGraphics extends Graphics2D {
	...
	public void drawRoundRect(int pX, int pY, int pWidth, int pHeight, int pArcWidth,
			int pArcHeight) {
	...
	protected void logMe(String title, int pX, int pY, int pWidth, int pHeight) {
		System.out.println(title + ", " + pX + ", " + pY + ", " + pWidth + ", " + pHeight);
	}
	...
	public void draw3DRect(int pX, int pY, int pWidth, int pHeight, boolean pRaised) {
	...
	public void fill3DRect(int pX, int pY, int pWidth, int pHeight, boolean pRaised) {
		mG.fill3DRect(pX, pY, pWidth, pHeight, pRaised);
	}

	public void fillRoundRect(int pX, int pY, int pWidth, int pHeight, int pArcWidth,
			int pArcHeight) {
	...
	public boolean drawImage(Image pImg, AffineTransform pXform, ImageObserver pObs) {
		return mG.drawImage(pImg, pXform, pObs);
	}

	public void drawImage(BufferedImage pImg, BufferedImageOp pOp, int pX, int pY) {
	...
	public void drawArc(int pX, int pY, int pWidth, int pHeight, int pStartAngle, int pArcAngle) {
	...
	public void fillArc(int pX, int pY, int pWidth, int pHeight, int pStartAngle, int pArcAngle) {
	...
	public void drawString(AttributedCharacterIterator pIterator, float pX, float pY) {
		mG.drawString(pIterator, pX, pY);
	}
	...
	public boolean drawImage(Image pImg, int pX, int pY, int pWidth, int pHeight,
	...
	public boolean drawImage(Image pImg, int pX, int pY, Color pBgcolor, ImageObserver pObserver) {
	...
	public boolean drawImage(Image pImg, int pX, int pY, int pWidth, int pHeight, Color pBgcolor,
			ImageObserver pObserver) {
	...
	public boolean drawImage(Image pImg, int pDx1, int pDy1, int pDx2, int pDy2, int pSx1, int pSy1,
			int pSx2, int pSy2, ImageObserver pObserver) {
		return mG.drawImage(pImg, pDx1, pDy1, pDx2, pDy2, pSx1, pSy1, pSx2, pSy2, pObserver);
	}
	...
	public boolean drawImage(Image pImg, int pDx1, int pDy1, int pDx2, int pDy2, int pSx1, int pSy1,
			int pSx2, int pSy2, Color pBgcolor, ImageObserver pObserver) {
		return mG.drawImage(pImg, pDx1, pDy1, pDx2, pDy2, pSx1, pSy1, pSx2, pSy2, pBgcolor,
				pObserver);
	}
