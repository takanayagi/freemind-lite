...
public class MindMapMock implements MindMap {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see freemind.modes.MindMap#loadTree(freemind.modes.ModeController.ReaderCreator,
	 * freemind.modes.MapAdapter.AskUserBeforeUpdateCallback)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see freemind.modes.MindMap#insertNodeInto(freemind.modes.MindMapNode,
	 * freemind.modes.MindMapNode, int)
	 */
	@Override
	public void insertNodeInto(MindMapNode pNode, MindMapNode pParentNode, int pIndex) {
