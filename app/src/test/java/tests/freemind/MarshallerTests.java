...
public class MarshallerTests extends FreeMindTestBase {
  ...
  public void testNewLines() {
    ...
    Pattern testPatternUnmarshalled = (Pattern) XmlBindingTools.getInstance().unMarshall(marshall);
    assertEquals(
        testPattern.getName(),
        testPatternUnmarshalled.getName(),
        "Newline is correctly marshalled?" + marshall);
    assertEquals(
        testPattern.getPatternChild().getValue(),
