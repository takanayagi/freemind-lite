...
public class Controller implements MapModuleChangeObserver {
  ...
  /**
   * Converts from a local link to the real file URL of the documentation map. (Used to change this
   * behaviour under MacOSX).
   */
  ...
  private static final float[] zoomValues = {
    25 / 100f, 50 / 100f, 75 / 100f, 100 / 100f, 150 / 100f, 200 / 100f, 300 / 100f, 400 / 100f
  };
  ...
  public void init() {
    ...
    freemindUrl =
        new OpenURLAction(this, getResourceString("FreeMind"), getProperty("webFreeMindLocation"));
  ...
  public void informationMessage(Object message, JComponent component) {
    JOptionPane.showMessageDialog(
        component, message.toString(), "FreeMind", JOptionPane.INFORMATION_MESSAGE);
  }
  ...
  public void errorMessage(Object message) {
    ...
    JOptionPane.showMessageDialog(
        getFrame().getContentPane(), myMessage, "FreeMind", JOptionPane.ERROR_MESSAGE);
  }

  public void errorMessage(Object message, JComponent component) {
    JOptionPane.showMessageDialog(
        component, message.toString(), "FreeMind", JOptionPane.ERROR_MESSAGE);
  }
  ...
  private class PrintAction extends AbstractAction {
    ...
    PrintAction(Controller controller, boolean isDlg) {
      super(
          isDlg
              ? controller.getResourceString("print_dialog")
              : controller.getResourceString("print"),
          freemind.view.ImageFactory.getInstance().createIcon(getResource("images/fileprint.png")));
      setEnabled(false);
      this.isDlg = isDlg;
    }
  ...
  private class PrintPreviewAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      PreviewDialog previewDialog =
          new PreviewDialog(
              controller.getResourceString("print_preview_title"), getView(), getPageFormat());
      previewDialog.pack();
  ...
  private class PageAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      fitToPage.addItemListener(
          e2 -> userZoom.setEditable(e2.getStateChange() == ItemEvent.DESELECTED));
    ...
    NavigationPreviousMapAction(Controller controller) {
      super(
          ...
          freemind.view.ImageFactory.getInstance()
              .createIcon(getResource("images/1leftarrow.png")));
      setEnabled(false);
    }
  ...
  private class ShowFilterToolbarAction extends AbstractAction {
    ShowFilterToolbarAction(Controller controller) {
      super(
          ...
          freemind.view.ImageFactory.getInstance().createIcon(getResource("images/filter.gif")));
    }
  ...
  private class NavigationMoveMapLeftAction extends AbstractAction {
    NavigationMoveMapLeftAction(Controller controller) {
      super(
          ...
          freemind.view.ImageFactory.getInstance()
              .createIcon(getResource("images/draw-arrow-back.png")));
      setEnabled(false);
    }
  ...
  private class NavigationMoveMapRightAction extends AbstractAction {
    NavigationMoveMapRightAction(Controller controller) {
      super(
          ...
          freemind.view.ImageFactory.getInstance()
              .createIcon(getResource("images/draw-arrow-forward.png")));
      setEnabled(false);
    }
          ...
          new OptionPanel(
              ...
              props -> {
                ...
                for (String key : sortedKeys) {
                  ...
                  propertiesChanged =
                      propertiesChanged || !newProperty.equals(controller.getProperty(key));
                  controller.setProperty(key, newProperty);
                }

                if (propertiesChanged) {
                  JOptionPane.showMessageDialog(
                      null, getResourceString("option_changes_may_require_restart"));
  ...
  public void addTabbedPane(JTabbedPane pTabbedPane) {
    ...
    registerMapTitleChangeListener(
        (pNewMapTitle, pMapModule, pModel) -> {
          for (int i = 0; i < mTabbedPaneMapModules.size(); ++i) {
  ...
  private void tabSelectionChanged() {
    ...
    for (int j = 0; j < mTabbedPane.getTabCount(); j++) {
      if (j != selectedIndex) mTabbedPane.setComponentAt(j, new JPanel());
    }
    if (selectedIndex < 0) {
    ...
    logger.fine(
        "Selected index of tab is now: " + selectedIndex + " with title:" + module.toString());
   ...
   */
  public void insertComponentIntoSplitPane(
      JComponent pMindMapComponent, SplitComponentType pSplitComponentType) {
