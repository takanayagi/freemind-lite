...
public class StructuredMenuHolder {
  ...
  private void updateMenus(
      MenuAdder menuAdder, Map<String, Object> thisMap, MenuAdderCreator factory) {
  ...
  public static boolean lastItemIsASeparator(JMenu menu) {
    ...
    return menu.getItemCount() > 0
        && menu.getMenuComponents()[menu.getItemCount() - 1] instanceof JSeparator;
  }
