...
public class MindMapNodesSelection implements Transferable, ClipboardOwner {
	...
	static {
		try {
			...
			copyNodeIdsFlavor =
					new DataFlavor("application/freemind-node-ids; class=java.util.List");
		} catch (Exception e) {
	...
	//
	public MindMapNodesSelection(String nodesContent, String imageContent, String stringContent,
			String rtfContent, String htmlContent, String dropActionContent, List<File> fileList,
			List<String> nodeIdsContent) {
	...
	public DataFlavor[] getTransferDataFlavors() {
		return new DataFlavor[] {DataFlavor.imageFlavor, DataFlavor.stringFlavor,
				mindMapNodesFlavor, rtfFlavor, htmlFlavor, dropActionFlavor, copyNodeIdsFlavor};
	}
	...
	public boolean isDataFlavorSupported(DataFlavor flavor) {
		...
		if (flavor.equals(fileListFlavor) && (fileList != null) && !fileList.isEmpty()) {
			return true;
		}
