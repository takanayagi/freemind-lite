...
public class ConditionFactory {
	...
	static String createDescription(String attribute, String simpleCondition, String value,
			boolean ignoreCase) {
		return attribute + " " + simpleCondition
				+ (value != null ? " \"" + value + "\"" : "")
	...
	public Condition createAttributeCondition(String attribute, NamedObject simpleCondition,
		...
		if (simpleCondition.equals(FILTER_DOES_NOT_EXIST)) // XXX FILTER_DOES_NOT_EXIST should be NamedObject?
	...
	public Condition createCondition(NamedObject attribute, NamedObject simpleCondition,
			String value, boolean ignoreCase) {
	...
	public NamedObject[] getNodeConditionNames() {
		return new NamedObject[] {FILTER_CONTAINS, FILTER_IS_EQUAL_TO, FILTER_IS_NOT_EQUAL_TO,
	...
	public NamedObject[] getAttributeConditionNames() {
		return new NamedObject[] {Resources.getInstance().createTranslatedString(FILTER_EXIST),
				...
				FILTER_IS_EQUAL_TO, FILTER_IS_NOT_EQUAL_TO, FILTER_GT, FILTER_GE, FILTER_LE,
				FILTER_LT,};
	}

	protected Condition createNodeCondition(NamedObject simpleCondition, String value,
			boolean ignoreCase) {
		if (ignoreCase) {
