...
public class SortedMapListModel extends AbstractListModel<Object> implements SortedListModel {
  ...
  public int getIndexOf(Object o) {
    ...
    while (i.hasNext()) {
      count++;
      if (i.next().equals(o)) return count;
    }
    return -1;
  }
   ...
   * (non-Javadoc)
   *
   * @see freemind.controller.filter.util.SortedListModel#replace(java.lang.Object,
   * java.lang.Object)
   */
  public void replace(Object oldO, Object newO) {
    if (oldO.equals(newO)) return;
