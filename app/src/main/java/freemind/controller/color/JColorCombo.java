/*
 * FreeMind - A Program for creating and viewing MindmapsCopyright (C) 2000-2015 Christian Foltin,
 * Joerg Mueller, Daniel Polansky, Dimitri Polivaev and others.
 * 
 * See COPYING for Details
 * 
 * This program is free software; you can redistribute it and/or modify it under the terms of the GNU
 * General Public License as published by the Free Software Foundation; either version 2of the
 * License, or (at your option) any later version.
 * 
 * This program is distributed in the hope that it will be useful,but WITHOUT ANY WARRANTY; without
 * even the implied warranty ofMERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See theGNU
 * General Public License for more details.
 * 
 * You should have received a copy of the GNU General Public License along with this program; if not,
 * write to the Free SoftwareFoundation, Inc., 59 Temple Place - Suite 330, Boston, MA 02111-1307,
 * USA.
 */
...
public class JColorCombo extends JComboBox<ColorPair> {
	...
	public static class ComboBoxRenderer extends JLabel implements ListCellRenderer<ColorPair> {
		 ...
		 */
		@Override
		public Component getListCellRendererComponent(JList<? extends ColorPair> list,
				ColorPair pair, int index, boolean isSelected, boolean cellHasFocus) {
			if (isSelected) {
	...
	public static ColorPair[] sColorList = new ColorPair[] {
			...
			new ColorPair(new Color(0x000000), "black"), new ColorPair(new Color(0x808080), "gray"),
			new ColorPair(new Color(0x800000), "maroon"), new ColorPair(new Color(0xFF0000), "red"),

			new ColorPair(new Color(0x008000), "green"), new ColorPair(new Color(0x00FF00), "lime"),

			new ColorPair(new Color(0x808000), "olive"),
			new ColorPair(new Color(0xFFFF00), "yellow"),

			new ColorPair(new Color(0x000080), "navy"), new ColorPair(new Color(0x0000FF), "blue"),

			new ColorPair(new Color(0x800080), "purple"),
			new ColorPair(new Color(0xFF00FF), "fuchsia"),
			new ColorPair(new Color(0x008080), "teal"), new ColorPair(new Color(0x00FFFF), "aqua"),
			...
			new ColorPair(new Color(0x00FFFF), "aqua"), new ColorPair(new Color(0x00FFFF), "cyan"),
			...
			new ColorPair(new Color(0xFFFFFF), "white"), new ColorPair(new Color(0xFFFAFA), "snow"),
