...
public class DefaultListModel<E> extends AbstractListModel<E> {
	 ...
	 * is not deprecated, the preferred method to use is <code>get(int)</code>, which implements the
	 ...
	 *         <code>index</code>; returns <code>-1</code> if the <code>elem</code> is not found in
	 *         the list
	 ...
	 * <code>set(int,Object)</code>, which implements the <code>List</code> interface defined in the
	 ...
	 * Throws an <code>ArrayIndexOutOfBoundsException</code> if the index is invalid. <blockquote>
	 * <b>Note:</b> Although this method is not deprecated, the preferred method to use is
	 * <code>add(int,Object)</code>, which implements the <code>List</code> interface defined in the
	 * 1.2 Collections framework. </blockquote>
	 *
