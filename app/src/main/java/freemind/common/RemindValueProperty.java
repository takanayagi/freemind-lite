...
public class RemindValueProperty extends ThreeCheckBoxProperty {
  ...
  protected void setState(int newState) {
    ...
    strings[TRUE_VALUE_INT] =
        mTextTranslator.getText("OptionalDontShowMeAgainDialog.ok").replaceFirst("&", "");
    strings[FALSE_VALUE_INT] =
        mTextTranslator.getText("OptionalDontShowMeAgainDialog.cancel").replaceFirst("&", "");
    strings[DON_T_TOUCH_VALUE_INT] =
        mTextTranslator.getText("OptionPanel.ask").replaceFirst("&", "");
