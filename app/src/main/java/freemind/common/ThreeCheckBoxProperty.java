...
public class ThreeCheckBoxProperty extends PropertyBean implements PropertyControl {
	...
	private static final ImageIcon PLUS_IMAGE = freemind.view.ImageFactory.getInstance()
			.createIcon(Resources.getInstance().getResource("images/edit_add.png"));

	private static final ImageIcon MINUS_IMAGE = freemind.view.ImageFactory.getInstance()
			.createIcon(Resources.getInstance().getResource("images/edit_remove.png"));
	...
	public void setValue(String value) {
		if (value == null || !(value.toLowerCase().equals(mTrueValue)
				...
				|| value.toLowerCase().equals(mDontTouchValue))) {
