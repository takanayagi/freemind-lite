...
public class OptionalDontShowMeAgainDialog {
  ...
  public interface DontShowPropertyHandler {
    /**
     * @return accepted are the following values as return values: * "" (means: show this dialog) *
     *     "true" (means: the answer was ok and I want to remember that). * "false" (means: the
     *     answer was cancel and I want to remember that).
     */
    String getProperty();
