/*
 * FreeMind - A Program for creating and viewing Mindmaps Copyright (C) 2005 Christian Foltin.
 *
...
public class OptionPanel implements TextTranslator {
	...
	public OptionPanel(FreeMind fm, JDialog frame, OptionPanelFeedback feedback) {
		...
		WindowConfigurationStorage storage = XmlBindingTools.getInstance()
				.decorateDialog(fm.getController(), frame, PREFERENCE_STORAGE_PROPERTY);
	...
	public void buildPanel() {
		...
		frame.getContentPane().add(new ButtonBarBuilder().addGlue().addButton(cancelButton)
				.addButton(okButton).build(), BorderLayout.SOUTH);
	}
	...
	private class KeyProperty extends PropertyBean implements PropertyControl {
	...
	private Vector<PropertyControl> getControls() {
		...
		controls.add(new ComboProperty(
				...
				new String[] {"automatic", "ar", "bg", "cs", "de", "dk", "en", "el", "es", "et",
						"eu", "fr", "gl", "hr", "hu", "id", "it", "ja", "ko", "lt", "nl", "nn",
						"nb", "pl", "pt_BR", "pt_PT", "ro", "ru", "sk", "se", "sl", "sr", "tr",
		...
		controls.add(new BooleanProperty(FreeMindCommon.CHECK_SPELLING + TOOLTIP_EXT,
		...
		controls.add(new BooleanProperty(FreeMindCommon.LOAD_LAST_MAP + TOOLTIP_EXT,
				FreeMindCommon.LOAD_LAST_MAP)); // true
		controls.add(new BooleanProperty(FreeMindCommon.LOAD_LAST_MAPS_AND_LAYOUT + TOOLTIP_EXT,
		...
		controls.add(
				new StringProperty("browsemode_initial_map.tooltip", "browsemode_initial_map")); // ./doc/freemind.mm
		controls.add(new NextLineProperty());
		controls.add(new SeparatorProperty("automatic_save"));
		controls.add(
				new StringProperty("time_for_automatic_save.tooltip", "time_for_automatic_save")); // 60000
		//
		...
		controls.add(
				new StringProperty("path_to_automatic_saves.tooltip", "path_to_automatic_saves")); // freemind_home
		...
		controls.add(new ComboProperty("standardnodestyle.tooltip", FreeMind.RESOURCES_NODE_STYLE,
				MindMapNode.NODE_STYLES, this)); // as_parent

		controls.add(new ComboProperty("standardrootnodestyle.tooltip",
				FreeMind.RESOURCES_ROOT_NODE_STYLE, new String[] {MindMapNode.STYLE_FORK,
		...
		controls.add(new ColorProperty("standardnodetextcolor.tooltip",
				...
				fmMain.getDefaultProperty(FreeMind.RESOURCES_NODE_TEXT_COLOR), this)); // #000000

		controls.add(new ColorProperty("standardedgecolor.tooltip", FreeMind.RESOURCES_EDGE_COLOR,
				fmMain.getDefaultProperty(FreeMind.RESOURCES_EDGE_COLOR), this)); // #808080

		controls.add(new ColorProperty("standardlinkcolor.tooltip", FreeMind.RESOURCES_LINK_COLOR,
				fmMain.getDefaultProperty(FreeMind.RESOURCES_LINK_COLOR), this)); // #b0b0b0

		controls.add(new ColorProperty("standardbackgroundcolor.tooltip",
				FreeMind.RESOURCES_BACKGROUND_COLOR,
				fmMain.getDefaultProperty(FreeMind.RESOURCES_BACKGROUND_COLOR), this)); // #ffffff

		controls.add(new BooleanProperty(FreeMind.RESOURCE_PRINT_ON_WHITE_BACKGROUND + TOOLTIP_EXT,
				FreeMind.RESOURCE_PRINT_ON_WHITE_BACKGROUND)); // true

		controls.add(new ColorProperty("standardcloudcolor.tooltip", FreeMind.RESOURCES_CLOUD_COLOR,
				fmMain.getDefaultProperty(FreeMind.RESOURCES_CLOUD_COLOR), this)); // #f0f0f0
		...
		controls.add(new NumberProperty("defaultfontsize.tooltip", "defaultfontsize", 1,
		...
		controls.add(new ComboProperty("standardedgestyle.tooltip", FreeMind.RESOURCES_EDGE_STYLE,
		...
		controls.add(new NumberProperty(FreeMind.SCALING_FACTOR_PROPERTY + TOOLTIP_EXT,
				FreeMind.SCALING_FACTOR_PROPERTY, 100, Integer.MAX_VALUE, 1));

		controls.add(
				new BooleanProperty("use_tabbed_pane.tooltip", FreeMind.RESOURCES_USE_TABBED_PANE)); // true
		controls.add(new ComboProperty(FreeMind.J_SPLIT_PANE_SPLIT_TYPE + TOOLTIP_EXT,
				FreeMind.J_SPLIT_PANE_SPLIT_TYPE,
				new String[] {FreeMind.VERTICAL_SPLIT_BELOW, FreeMind.HORIZONTAL_SPLIT_RIGHT},
				this));
		...
		controls.add(
				new BooleanProperty(FreeMind.RESOURCE_DRAW_RECTANGLE_FOR_SELECTION + TOOLTIP_EXT,
		...
		controls.add(new ColorProperty("standardselectednoderectanglecolor.tooltip",
				...
				fmMain.getDefaultProperty(FreeMind.RESOURCES_SELECTED_NODE_RECTANGLE_COLOR), this)); // #000000

		controls.add(new ColorProperty("standardselectednodecolor.tooltip",
				FreeMind.RESOURCES_SELECTED_NODE_COLOR,
				fmMain.getDefaultProperty(FreeMind.RESOURCES_SELECTED_NODE_COLOR), this)); // #D2D2D2

		/* ***************************************************************** */
		controls.add(new NextLineProperty());
		final String RESOURCE_ROOT_NODE = "root_node_appearance";
		final String RESOURCE_USE_COMMON_OUT_POINT_FOR_ROOT_NODE =
				"use_common_out_point_for_root_node";
		controls.add(new SeparatorProperty(RESOURCE_ROOT_NODE));
		controls.add(new BooleanProperty(RESOURCE_USE_COMMON_OUT_POINT_FOR_ROOT_NODE + TOOLTIP_EXT,
				RESOURCE_USE_COMMON_OUT_POINT_FOR_ROOT_NODE)); // false
		/* ***************************************************************** */
		controls.add(new NextLineProperty());
		controls.add(new SeparatorProperty("anti_alias"));
		controls.add(new ComboProperty("antialias.tooltip", FreeMindCommon.RESOURCE_ANTIALIAS,
				new String[] {"antialias_edges", "antialias_all", "antialias_none"}, this)); // true
		...
		controls.add(new ComboProperty("links.tooltip", "links",
				new String[] {"relative", "absolute"}, this)); // relative
		controls.add(new BooleanProperty(FreeMindCommon.CREATE_THUMBNAIL_ON_SAVE + TOOLTIP_EXT,
				FreeMindCommon.CREATE_THUMBNAIL_ON_SAVE)); // true
		controls.add(new NumberProperty(FreeMindCommon.THUMBNAIL_SIZE + TOOLTIP_EXT,
				FreeMindCommon.THUMBNAIL_SIZE, 1, 10000, 1));

		/* ***************************************************************** */
		controls.add(new NextLineProperty());
		controls.add(new SeparatorProperty("edit_long_node_window"));
		controls.add(new StringProperty("el__buttons_position.tooltip", "el__buttons_position")); // above
		...
		controls.add(new NumberProperty(FreeMind.TOOLTIP_DISPLAY_TIME + ".tooltip",
				FreeMind.TOOLTIP_DISPLAY_TIME, 0, Integer.MAX_VALUE, 1)); // 4000
		controls.add(new SeparatorProperty("icon_properties"));
		controls.add(
				new StringProperty("icon_order_description", MindIcon.PROPERTY_STRING_ICONS_LIST));
		controls.add(new NumberProperty(null, FreeMind.ICON_BAR_COLUMN_AMOUNT, 1, 10, 1));
		/***********************************************************************
		 * Keystrokes ****************************************************************
		 */
		String form = "right:max(40dlu;p), 4dlu, 80dlu, 7dlu";
		controls.add(new NewTabProperty("Keystrokes", form + "," + form)); // ", right:max(40dlu;p),
																			// 4dlu, 60dlu"));
		//
		...
		controls.add(new KeyProperty(frame, null, "keystroke_export_branch_to_html")); // control
		// H

		controls.add(new KeyProperty(frame, null, "keystroke_open_first_in_history")); // control
		// shift
		// W
		...
		controls.add(new KeyProperty(frame, null, "keystroke_node_toggle_italic")); // control
		// I

		controls.add(new KeyProperty(frame, null, "keystroke_node_toggle_boldface")); // control
		// B

		controls.add(new KeyProperty(frame, null, "keystroke_node_toggle_strikethrough"));

		controls.add(new KeyProperty(frame, null, "keystroke_node_toggle_underlined")); // control
		// U
		...
		controls.add(new KeyProperty(frame, null, "keystroke_add_arrow_link_action")); // control
		// L

		controls.add(new KeyProperty(frame, null, "keystroke_add_local_link_action")); // alt
		...
		controls.add(new KeyProperty(frame, null, "keystroke_add_sibling_before")); // shift
		...
		controls.add(new KeyProperty(frame, null, "keystroke_toggle_children_folded")); // control
		// SPACE

		controls.add(new KeyProperty(frame, null, "keystroke_set_link_by_filechooser")); // control
		// shift
		// K

		controls.add(new KeyProperty(frame, null, "keystroke_set_link_by_textfield")); // control
		// K

		controls.add(new KeyProperty(frame, null, "keystroke_set_image_by_filechooser")); // alt
		// K
		...
		controls.add(new KeyProperty(frame, null, "keystroke_node_increase_font_size")); // control
		// PLUS

		controls.add(new KeyProperty(frame, null, "keystroke_node_decrease_font_size")); // control
		// MINUS
		...
		if (modeController instanceof MindMapController controller) {
			...
			Vector<IconInformation> actions = new Vector<>(iconActions);
			...
			for (IconInformation info : actions) {
				final KeyProperty keyProperty =
						new KeyProperty(frame, null, info.getKeystrokeResourceName());
		...
		controls.add(new BooleanProperty(FreeMind.RESOURCES_SEARCH_IN_NOTES_TOO + TOOLTIP_EXT,
				FreeMind.RESOURCES_SEARCH_IN_NOTES_TOO));

		controls.add(new ComboProperty("placenewbranches.tooltip", "placenewbranches",
				new String[] {"first", "last"}, this)); // last
		...
		controls.add(new BooleanProperty("enable_leaves_folding.tooltip", "enable_leaves_folding")); // false

		controls.add(new StringProperty("foldingsymbolwidth.tooltip", "foldingsymbolwidth")); // 6

		controls.add(new NextLineProperty());
		controls.add(new SeparatorProperty("key_typing"));
		controls.add(new BooleanProperty("disable_key_type.tooltip", "disable_key_type")); // false

		controls.add(new BooleanProperty("key_type_adds_new.tooltip", "key_type_adds_new")); // false
		...
		controls.add(new RemindValueProperty("remind_type_of_new_nodes.tooltip",
				FreeMind.RESOURCES_REMIND_USE_RICH_TEXT_IN_NEW_LONG_NODES, modeController));
		controls.add(
				new DontShowNotificationProperty("resources_convert_to_current_version.tooltip",
						FreeMind.RESOURCES_CONVERT_TO_CURRENT_VERSION));
		controls.add(new RemindValueProperty("reload_files_without_question.tooltip",
		...
		controls.add(new RemindValueProperty(FreeMind.RESOURCES_COMPLETE_CLONING + ".tooltip",
		...
		controls.add(new ComboProperty("selection_method.tooltip",
				FreeMind.RESOURCES_SELECTION_METHOD, new String[] {"selection_method_direct",
		...
		controls.add(new NumberProperty("wheel_velocity.tooltip", FreeMind.RESOURCES_WHEEL_VELOCITY,
				1, 250, 1));
		controls.add(new NextLineProperty());
		...
		controls.add(new ComboProperty(null, "html_export_folding",
				new String[] {"html_export_no_folding", "html_export_fold_currently_folded",
						"html_export_fold_all", "html_export_based_on_headings"},
				this)); // html_export_fold_currently_folded

		controls.add(new NextLineProperty());
		controls.add(new BooleanProperty("export_icons_in_html.tooltip", "export_icons_in_html")); // false
	...
	private static Set<FreemindPropertyContributor> sContributors =
			new HashSet<>();
	...
	private KeyBinding createBinding(String name, String label, String shortcut,
