...
public class OptionPanel implements TextTranslator {
  ...
  private KeyProperty findControlByKB(KeyBinding binding) {
    for (PropertyControl control : controls) {
      if (control instanceof KeyProperty k) {
        if (k.kb.equals(binding)) return k;
      }
    }
    return null;
  }
  ...
  public void buildPanel() {
    ...
    JSplitPane centralPanel =
        new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, leftBuilder.getPanel(), rightScrollPane);
  ...
  private Vector<PropertyControl> getControls() {
    ...
    controls.add(
        new ComboProperty(
             ...
             */
            "language.tooltip",
            FreeMindCommon.RESOURCE_LANGUAGE,
            new String[] {
              "automatic",
              "ar",
              "bg",
    ...
    controls.add(
        new BooleanProperty(
            FreeMindCommon.CHECK_SPELLING + TOOLTIP_EXT, FreeMindCommon.CHECK_SPELLING)); // true
    ...
    controls.add(
        new BooleanProperty(
            FreeMindCommon.LOAD_LAST_MAP + TOOLTIP_EXT, FreeMindCommon.LOAD_LAST_MAP)); // true
    controls.add(
        new BooleanProperty(
    ...
    controls.add(
        new BooleanProperty(
            "delete_automatic_saves_at_exit.tooltip", "delete_automatic_saves_at_exit")); // true
    ...
    controls.add(
        new BooleanProperty(
            "resources_save_folding_state.tooltip", FreeMind.RESOURCES_SAVE_FOLDING_STATE)); // true
    controls.add(
        new BooleanProperty(
    ...
    controls.add(
        new ComboProperty(
            "standardnodestyle.tooltip",
            FreeMind.RESOURCES_NODE_STYLE,
            MindMapNode.NODE_STYLES,
            this)); // as_parent
    ...
    controls.add(
        new ComboProperty(
            ...
            new String[] {
              MindMapNode.STYLE_FORK, MindMapNode.STYLE_BUBBLE, MindMapNode.STYLE_COMBINED
            },
            this)); // fork
    ...
    controls.add(
        new ColorProperty(
            "standardedgecolor.tooltip",
            FreeMind.RESOURCES_EDGE_COLOR,
            fmMain.getDefaultProperty(FreeMind.RESOURCES_EDGE_COLOR),
            this)); // #808080

    controls.add(
        new ColorProperty(
            "standardlinkcolor.tooltip",
            FreeMind.RESOURCES_LINK_COLOR,
            fmMain.getDefaultProperty(FreeMind.RESOURCES_LINK_COLOR),
            this)); // #b0b0b0

    controls.add(
        new ColorProperty(
            "standardbackgroundcolor.tooltip",
    ...
    controls.add(
        new ColorProperty(
            "standardcloudcolor.tooltip",
            FreeMind.RESOURCES_CLOUD_COLOR,
            fmMain.getDefaultProperty(FreeMind.RESOURCES_CLOUD_COLOR),
            this)); // #f0f0f0

    controls.add(new NextLineProperty());
    controls.add(new SeparatorProperty("default_fonts"));
    controls.add(new StringProperty("defaultfont.tooltip", "defaultfont")); // SansSerif
    ...
    controls.add(
        new NumberProperty(
            ...
            "defaultfontsize",
            1,
            96 /* taken from openoffice as maximum. */,
            1)); // 12
    // controls.add(new StringProperty(null, "defaultfontsize")); // 12

    controls.add(
        new NumberProperty(
            "max_node_width.tooltip", "max_node_width", 1, Integer.MAX_VALUE, 1)); // 600

    controls.add(
        new NumberProperty(
            "max_tooltip_width.tooltip", "max_tooltip_width", 1, Integer.MAX_VALUE, 1)); // 600

    controls.add(new NextLineProperty());
    controls.add(new SeparatorProperty("other_defaults"));
    controls.add(
        new ComboProperty(
            "standardedgestyle.tooltip",
            FreeMind.RESOURCES_EDGE_STYLE,
            new String[] {"bezier", "linear"},
            this)); // bezier
    ...
    controls.add(
        new ComboProperty(
            "lookandfeel.tooltip",
            FreeMind.RESOURCE_LOOKANDFEEL,
            lafNames,
            translatedLafNames)); // default

    controls.add(
        new NumberProperty(
            FreeMind.SCALING_FACTOR_PROPERTY + TOOLTIP_EXT,
            FreeMind.SCALING_FACTOR_PROPERTY,
            100,
            Integer.MAX_VALUE,
            1));
    ...
    controls.add(
        new ComboProperty(
            FreeMind.J_SPLIT_PANE_SPLIT_TYPE + TOOLTIP_EXT,
    ...
    controls.add(
        new NumberProperty(
            ...
            StructuredMenuHolder.AMOUNT_OF_VISIBLE_MENU_ITEMS,
            10,
            Integer.MAX_VALUE,
            1));
    ...
    controls.add(
        new BooleanProperty(
            FreeMind.RESOURCES_DISPLAY_FOLDING_BUTTONS + TOOLTIP_EXT,
    ...
    controls.add(
        new ComboProperty(
            "links.tooltip", "links", new String[] {"relative", "absolute"}, this)); // relative
    controls.add(
        new BooleanProperty(
    ...
    controls.add(
        new NumberProperty(
            FreeMindCommon.THUMBNAIL_SIZE + TOOLTIP_EXT,
            FreeMindCommon.THUMBNAIL_SIZE,
            1,
            10000,
            1));
    ...
    controls.add(
        new StringProperty("el__buttons_position.tooltip", "el__buttons_position")); // above
    ...
    controls.add(
        new NumberProperty(
            FreeMind.TOOLTIP_DISPLAY_TIME + ".tooltip",
    ...
    controls.add(
        new KeyProperty(
            frame, null, "keystroke_accessories/plugins/FormatCopy.properties.properties_key"));
    controls.add(
        new KeyProperty(
            frame, null, "keystroke_accessories/plugins/FormatPaste.properties.properties_key"));
    controls.add(
        new KeyProperty(
            frame,
            null,
    ...
    controls.add(
        new KeyProperty(frame, null, "keystroke_accessories/plugins/NewParentNode.properties_key"));
    // controls.add(new KeyProperty(frame, null,
    // "keystroke_accessories/plugins/NodeNote.properties_key"));
    controls.add(
        new KeyProperty(
            frame, null, "keystroke_accessories/plugins/NodeNote_jumpto.keystroke.alt_N"));
    controls.add(
        new KeyProperty(
            frame,
            null,
    ...
    controls.add(
        new KeyProperty(
            frame, null, "keystroke_accessories/plugins/RemoveNote.properties.properties_key"));
    controls.add(
        new KeyProperty(
            frame, null, "keystroke_accessories/plugins/UnfoldAll.keystroke.alt_PAGE_UP"));
    controls.add(
        new KeyProperty(
            frame, null, "keystroke_accessories/plugins/UnfoldAll.keystroke.alt_PAGE_DOWN"));
    controls.add(
        new KeyProperty(frame, null, "keystroke_accessories/plugins/UnfoldAll.keystroke.alt_HOME"));
    controls.add(
        new KeyProperty(frame, null, "keystroke_accessories/plugins/UnfoldAll.keystroke.alt_END"));
    ...
    controls.add(
        new BooleanProperty(
            FreeMind.RESOURCES_SEARCH_IN_NOTES_TOO + TOOLTIP_EXT,
            FreeMind.RESOURCES_SEARCH_IN_NOTES_TOO));

    controls.add(
        new ComboProperty(
            "placenewbranches.tooltip",
            "placenewbranches",
    ...
    controls.add(
        new BooleanProperty(
            FreeMind.RESOUCES_PASTE_HTML_STRUCTURE + TOOLTIP_EXT,
    ...
    controls.add(
        new BooleanProperty("enable_leaves_folding.tooltip", "enable_leaves_folding")); // false
    ...
    controls.add(
        new DontShowNotificationProperty(
            "cut_nodes_without_question.tooltip", FreeMind.RESOURCES_CUT_NODES_WITHOUT_QUESTION));
    controls.add(
        new DontShowNotificationProperty(
    ...
    controls.add(
        new ComboProperty(
            ...
            new String[] {
              "selection_method_direct", "selection_method_delayed", "selection_method_by_click"
            },
            this)); // selection_method_direct

    controls.add(
        new NumberProperty(
            "time_for_delayed_selection.tooltip",
    ...
    controls.add(
        new NumberProperty("wheel_velocity.tooltip", FreeMind.RESOURCES_WHEEL_VELOCITY, 1, 250, 1));
    controls.add(new NextLineProperty());
    ...
    controls.add(
        new StringProperty(
            "default_browser_command_mac.tooltip", "default_browser_command_mac")); // open -a
    ...
    controls.add(new NextLineProperty());
    controls.add(
        new BooleanProperty("export_icons_in_html.tooltip", "export_icons_in_html")); // false
  ...
  public void closeWindow() {
    ...
    XmlBindingTools.getInstance()
        .storeDialogPositions(fmMain.getController(), frame, storage, PREFERENCE_STORAGE_PROPERTY);
  ...
  private KeyBinding createBinding(
      String name, String label, String shortcut, KeyProperty keyProperty) {
