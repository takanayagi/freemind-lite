...
/**
 * Various hacks to get keyboard event handling to behave in a consistent manner across Java
 * implementations.
 *
 * @author Slava Pestov
        ...
        switch (keyCode) {
          ...
          default:
            ...
            if (ALT_KEY_PRESSED_DISABLED) {
              ...
              if ((modifiers & InputEvent.ALT_DOWN_MASK) != 0) return null;
            }
      ...
      case KeyEvent.KEY_RELEASED:
        switch (keyCode) {
          ...
          case KeyEvent.VK_HOME:
             ...
             */
            if (modifiers == InputEvent.ALT_DOWN_MASK) last = LAST_ALT;
            break;
        }
        return evt;
      // }}}
