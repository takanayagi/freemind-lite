 ...
 * 
 * The use case for these registration classes to provide some static data, caches. Some plugins use
 * it to register additional preference pages. Others register a mouse wheel listener.
 * 
 * @author foltin
 * 
 */
