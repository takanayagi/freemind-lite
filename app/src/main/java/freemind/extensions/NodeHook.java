...
/**
 * This is a general base interface for hooks that implement actions belonging to nodes. They are
 * normally started due to a user interaction.
 *
 * <p>There are two different types of NodeHooks:
 *
 * <ol>
 *   <li>non-permanent hooks: do something and terminate.
 *   <li>permanent hooks: when started, they stick to the node, are stored with it and recreated,
 *       when the map with the node is loaded the next time.
 * </ol>
 *
 * Examples are
 *
