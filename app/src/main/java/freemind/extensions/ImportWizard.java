/*
 * ImportWizard.java Copyright (C) 1999 Len Trigg (trigg@cs.waikato.ac.nz)
 *
...
public class ImportWizard {
	...
	public void buildClassList() {
		...
		classPath = Resources.getInstance().getFreemindBaseDir() + classPathSeparator + classPath;
	 ...
	 * @param recursionLevel To ensure that after a certain depth the recursive directory search
	 *        stops
	 */
	public void addClassesFromDir(Vector<String> classList, File rootDir, File currentDir,
			int recursionLevel) {
		if (recursionLevel >= 6) {
...
/*
 * $Log: ImportWizard.java,v $ Revision 1.1.4.6.2.16 2008/07/28 03:06:01 christianfoltin * Bug fix:
 * B19 startup fails with "Mode not available: Mindmap" *
 * https://sourceforge.net/tracker/?func=detail&atid =107118&aid=2025279&group_id=7118 * FreeMind
 * Starter: no more statics.
 * 
 * Revision 1.1.4.6.2.15 2008/07/18 16:14:25 christianfoltin * Renamed zh into zh_TW (patch from
 * willyann * Reverted changes to Tools.
 * 
 * Revision 1.1.4.6.2.14 2006/12/14 16:45:00 christianfoltin * Search & Replace Dialog with menu and
 * nicer. Bug fixes...
 * 
 * Revision 1.1.4.6.2.13 2006/11/28 08:25:01 dpolivaev no message
 * 
 * Revision 1.1.4.6.2.12 2006/11/26 10:20:40 dpolivaev LocalProperties, TextResources for SHTML and
 * Bug Fixes
 * 
 * Revision 1.1.4.6.2.11 2006/11/12 21:07:06 christianfoltin * Mac bug fixes (class path, error
