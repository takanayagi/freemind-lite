 ...
 * XMLElement.java
 *
 * $Revision: 1.7.18.4.2.8 $ $Date: 2009/08/27 20:04:10 $ $Name: fm_060405_integration $
 *
 * This file is part of NanoXML 2 Lite. Copyright (C) 2000-2002 Marc De Scheemaecker, All Rights
 * Reserved.
 *
 ...
 *
 * <DL>
 *   <DT><B>Retrieving Attributes</B>
 *   <DD>You can enumerate the attributes of an element using the method {@link
 *       #enumerateAttributeNames() enumerateAttributeNames}. The attribute values can be retrieved
 *       using the method {@link #getStringAttribute(java.lang.String) getStringAttribute}. The
 ...
 *
 * <DL>
 *   <DT><B>Retrieving Child Elements</B>
 *   <DD>You can enumerate the children of an element using {@link #enumerateChildren()
 *       enumerateChildren}. The number of child elements can be retrieved using {@link
 *       #countChildren() countChildren}.
 * </DL>
 *
 * <DL>
 *   <DT><B>Elements Containing Character Data</B>
 ...
 *
 * <DL>
 *   <DT><B>Subclassing XMLElement</B>
 *   <DD>When subclassing XMLElement, you need to override the method {@link #createAnotherElement()
 *       createAnotherElement} which has to return a new copy of the receiver.
 * </DL>
 *
 * <p>
 *
...
public class XMLElement {
  ...
  public static final String XML_NODE_XHTML_CONTENT_END_TAG_REGEXP =
      "<\\s*/\\s*" + XML_NODE_XHTML_CONTENT_TAG + "\\s*>";
  ...
  /**
   * Major version of NanoXML. Classes with the same major and minor version are binary compatible.
   * Classes with the same major version are source compatible. If the major version is different,
   * you may need to modify the client source code.
   *
  ...
  /**
   * Minor version of NanoXML. Classes with the same major and minor version are binary compatible.
   * Classes with the same major version are source compatible. If the major version is different,
   * you may need to modify the client source code.
   *
   ...
   *         <li>The field can be empty.
   *         <li>The field is never <code>null</code>.
   *         <li>The elements are instances of <code>XMLElement</code> or a subclass of <code>
   *             XMLElement</code>.
   *       </ul>
   * </dl>
   */
   ...
   *   <dd>
   *       <ul>
   *         <li>The field is <code>null</code> iff the element is not initialized by either parse
   *             or setName.
  ...
  /**
   * Conversion table for &amp;...; entities. The keys are the entity names without the &amp; and ;
   * delimiters.
   *
   * <dl>
   *   <dt><b>Invariants:</b>
   ...
   * </dl>
   *
   * @see freemind.main.XMLElement#XMLElement(java.util.Hashtable) XMLElement(Hashtable)
   * @see freemind.main.XMLElement#XMLElement(boolean)
   * @see freemind.main.XMLElement#XMLElement(java.util.Hashtable,boolean) XMLElement(Hashtable,
   *     boolean)
   */
  public XMLElement() {
   ...
   * </ul>
   *
   * The entity conversion table. <code>true</code> if leading and trailing whitespace in PCDATA
   ...
   *
   * <p>The entity conversion table. <code>true</code> if leading and trailing whitespace in PCDATA
   * content has to be removed. <code>true</code> if the case of element and attribute names have to
   * be ignored.
   * </dl>
   *
   * <dl>
   ...
   */
  public XMLElement(
      Hashtable<String, char[]> entities, boolean skipLeadingWhitespace, boolean ignoreCase) {
   ...
   * Creates and initializes a new XML element.
   *
   * <p>This constructor should <I>only</I> be called from {@link #createAnotherElement()
   * createAnotherElement} to create child elements.
   *
   * <p>The entity conversion table. <code>true</code> if leading and trailing whitespace in PCDATA
   * content has to be removed. <code>true</code> if the basic entities need to be added to the
   * entity list. <code>true</code> if the case of element and attribute names have to be ignored.
   * </dl>
   *
   * <dl>
   *   <dt><b>Preconditions:</b>
   ...
   *             contains at least the following entries: <code>amp</code>, <code>lt</code>, <code>
   *             gt</code>, <code>apos</code> and <code>quot</code>
   *       </ul>
   * </dl>
   *
   * <dl>
  ...
  protected XMLElement(
      Hashtable<String, char[]> entities,
   ...
   * @see freemind.main.XMLElement#removeChild(XMLElement) removeChild(XMLElement)
   */
   ...
   *
   * <p>The name of the attribute. The value of the attribute.
   * </dl>
   *
   * <dl>
   *   <dt><b>Preconditions:</b>
   ...
   * @see freemind.main.XMLElement#setIntAttribute(java.lang.String, int) setIntAttribute(String,
   *     int)
   * @see freemind.main.XMLElement#enumerateAttributeNames()
   * @see freemind.main.XMLElement#getAttribute(java.lang.String) getAttribute(String)
   * @see freemind.main.XMLElement#getAttribute(java.lang.String, java.lang.Object)
   *     getAttribute(String, Object)
   * @see freemind.main.XMLElement#getAttribute(java.lang.String, java.util.Hashtable,
   *     java.lang.String, boolean) getAttribute(String, Hashtable, String, boolean)
   * @see freemind.main.XMLElement#getStringAttribute(java.lang.String) getStringAttribute(String)
   * @see freemind.main.XMLElement#getStringAttribute(java.lang.String, java.lang.String)
   *     getStringAttribute(String, String)
   * @see freemind.main.XMLElement#getStringAttribute(java.lang.String, java.util.Hashtable,
   *     java.lang.String, boolean) getStringAttribute(String, Hashtable, String, boolean)
   */
   ...
   * @see freemind.main.XMLElement#removeAttribute(java.lang.String) removeAttribute(String)
   * @see freemind.main.XMLElement#enumerateAttributeNames()
   * @see freemind.main.XMLElement#getIntAttribute(java.lang.String) getIntAttribute(String)
   * @see freemind.main.XMLElement#getIntAttribute(java.lang.String, int) getIntAttribute(String,
   *     int)
   * @see freemind.main.XMLElement#getIntAttribute(java.lang.String, java.util.Hashtable,
   *     java.lang.String, boolean) getIntAttribute(String, Hashtable, String, boolean)
   */
   ...
   * @see freemind.main.XMLElement#removeAttribute(java.lang.String) removeAttribute(String)
   * @see freemind.main.XMLElement#enumerateAttributeNames()
   * @see freemind.main.XMLElement#getDoubleAttribute(java.lang.String) getDoubleAttribute(String)
   * @see freemind.main.XMLElement#getDoubleAttribute(java.lang.String, double)
   *     getDoubleAttribute(String, double)
   * @see freemind.main.XMLElement#getDoubleAttribute(java.lang.String, java.util.Hashtable,
   *     java.lang.String, boolean) getDoubleAttribute(String, Hashtable, String, boolean)
   */
   ...
   * <p>The name of the attribute. The value of the attribute.
   *
   * @deprecated Use {@link #setDoubleAttribute(java.lang.String, double) setDoubleAttribute}
   *     instead.
   */
  @Deprecated
   ...
   * @see freemind.main.XMLElement#getDoubleAttribute(java.lang.String, java.util.Hashtable,
   *     java.lang.String, boolean) getDoubleAttribute(String, Hashtable, String, boolean)
   * @see freemind.main.XMLElement#getBooleanAttribute(java.lang.String, java.lang.String,
   *     java.lang.String, boolean) getBooleanAttribute(String, String, String, boolean)
   */
  ...
  public Vector<XMLElement> getChildren() {
    try {
      ...
      Vector<XMLElement> clonedChildren = (Vector<XMLElement>) this.children.clone();
   ...
   * returned.
   *
   * @see freemind.main.XMLElement#setContent(java.lang.String) setContent(String)
   */
  ...
  /**
   * Returns an attribute by looking up a key in a hashtable. If the attribute doesn't exist, the
   * value corresponding to defaultKey is returned.
   *
   * <p>As an example, if valueSet contains the mapping <code>"one" =>
   * "1"</code> and the element contains the attribute <code>attr="one"</code> , then <code>
   * getAttribute("attr", mapping, defaultKey, false)</code> returns <code>"1"</code>.
   *
   * <p>The name of the attribute. Hashtable mapping keys to values. Key to use if the attribute is
   * missing. <code>true</code> if literals are valid.
   * </dl>
   *
   * <dl>
   *   <dt><b>Preconditions:</b>
  ...
  public Object getAttribute(
      String name, Hashtable<String, ?> valueSet, String defaultKey, boolean allowLiterals) {
    if (this.ignoreCase) {
      name = name.toUpperCase(Locale.ENGLISH);
    }
  ...
  public String getStringAttribute(
      String name, Hashtable<String, String> valueSet, String defaultKey, boolean allowLiterals) {
    return (String) this.getAttribute(name, valueSet, defaultKey, allowLiterals);
  }

  /**
   * Returns an attribute of the element. If the attribute doesn't exist, <code>0</code> is
   * returned.
   *
   * @param name The name of the attribute.
   *     </dl>
   ...
   * value corresponding to defaultKey is returned.
   *
   * <p>As an example, if valueSet contains the mapping <code>"one" => 1</code> and the element
   * contains the attribute <code>attr="one"</code>, then <code>
   * getIntAttribute("attr", mapping, defaultKey, false)</code> returns <code>1</code>.
   *
   * <p>The name of the attribute. Hashtable mapping keys to values. Key to use if the attribute is
   * missing. <code>true</code> if literal numbers are valid.
   * </dl>
   *
   * <dl>
   *   <dt><b>Preconditions:</b>
   ...
   *         <li><code>defaultKey</code> is either <code>null</code>, a key in <code>valueSet</code>
   *             or an integer.
   *       </ul>
   * </dl>
   *
  ...
  public int getIntAttribute(
      String name,
      Hashtable<Object, Integer> valueSet,
      String defaultKey,
  ...
  /**
   * Returns an attribute of the element. If the attribute doesn't exist, <code>0.0</code> is
   * returned.
   *
   * @param name The name of the attribute.
   *     </dl>
   ...
   *
   * <p>As an example, if valueSet contains the mapping <code>"one" =&gt;
   * 1.0</code> and the element contains the attribute <code>attr="one"</code> , then <code>
   * getDoubleAttribute("attr", mapping, defaultKey, false)</code> returns <code>1.0</code>.
   *
   * <p>The name of the attribute. Hashtable mapping keys to values. Key to use if the attribute is
   * missing. <code>true</code> if literal numbers are valid.
   * </dl>
  ...
  public double getDoubleAttribute(
      String name,
      Hashtable<Object, Double> valueSet,
      String defaultKey,
      boolean allowLiteralNumbers) {
    if (this.ignoreCase) {
      name = name.toUpperCase(Locale.ENGLISH);
  ...
  /**
   * Returns an attribute of the element. If the attribute doesn't exist, <code>defaultValue</code>
   * is returned. If the value of the attribute is equal to <code>trueValue</code>, <code>true
   * </code> is returned. If the value of the attribute is equal to <code>falseValue</code>, <code>
   * false</code> is returned. If the value doesn't match <code>trueValue</code> or <code>falseValue
  ...
  public boolean getBooleanAttribute(
      String name, String trueValue, String falseValue, boolean defaultValue) {
    if (this.ignoreCase) {
      name = name.toUpperCase(Locale.ENGLISH);
    }
    Object value = this.attributes.get(name);
   ...
   *
   * <p>The reader from which to retrieve the XML data.
   * </dl>
   *
   * <dl>
   *   <dt><b>Preconditions:</b>
   ...
   *   <dd>
   *       <ul>
   *         <li>the state of the receiver is updated to reflect the XML element parsed from the
   *             reader
   *         <li>the reader points to the first character following the last '&gt;' character of the
   *             XML element
   *       </ul>
   * </dl>
   *
   ...
   * Reads one XML element from a java.io.Reader and parses it.
   *
   * <p>The reader from which to retrieve the XML data. The line number of the first line in the
   * data.
   * </dl>
   *
   * <dl>
   ...
   * Reads one XML element from a String and parses it.
   *
   * <p>The reader from which to retrieve the XML data. The first character in <code>string</code>
   * to scan.
   * </dl>
   *
   * <dl>
   ...
   *
   * <p>The reader from which to retrieve the XML data. The first character in <code>string</code>
   * to scan. The character where to stop scanning. This character is not scanned.
   * </dl>
   *
   * <dl>
   *   <dt><b>Preconditions:</b>
   ...
   *
   * <p>The reader from which to retrieve the XML data. The first character in <code>string</code>
   * to scan. The character where to stop scanning. This character is not scanned. The line number
   * of the first line in the data.
   * </dl>
   *
   * <dl>
   *   <dt><b>Preconditions:</b>
   ...
   *
   * <p>You should override this method when subclassing XMLElement.
   */
   ...
   *
   * <p>The writer to write the XML data to.
   * </dl>
   *
   * <dl>
   *   <dt><b>Preconditions:</b>
  ...
  public void write(Writer writer, boolean withClosingTag) throws IOException {
    ...
    if ((this.contents != null) && (!this.contents.isEmpty())) {
      ...
      writer.write('>');
      writer.write('\n');
      Enumeration<XMLElement> enumerator = this.enumerateChildren();
      while (enumerator.hasMoreElements()) {
   ...
   *
   * <p>The writer to write the XML data to. The string to write encoded.
   * </dl>
   *
   * <dl>
   *   <dt><b>Preconditions:</b>
   ...
   * </code>.
   *
   * <p>The buffer in which the scanned identifier will be put.
   * </dl>
   *
   * <dl>
   *   <dt><b>Preconditions:</b>
   ...
   *       <ul>
   *         <li><code>result != null</code>
   *         <li>The next character read from the reader is a valid first character of an XML
   *             identifier.
   *       </ul>
   * </dl>
   *
  ...
  protected void scanElement(XMLElement elt) throws IOException {
    ...
    if (XML_NODE_XHTML_CONTENT_TAG.equals(name)) {
      /*
       * special case of html content tag: collect chars until </...> occurs.
       */
      ...
      for (; ; ) {
        ...
        if (ch == '>' && lastOpeningBreak >= 0) {
          ...
          if (sContentEndTagPattern == null) {
            sContentEndTagPattern = Pattern.compile(XML_NODE_XHTML_CONTENT_END_TAG_REGEXP);
          }
