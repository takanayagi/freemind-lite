 ...
 *
 * <p>The result will be a valid XML file, but it is not granted that the file will really be XHTML
 * 1.0 transitional conform. The basic purpose of this class is to give an XSL processor access to
 * plain HTML files.
 *
...
public class XHTMLWriter extends FixedHTMLWriter {
  ...
  /**
   * Read HTML from the Reader, and send XHTML to the writer. Common mistakes in the HTML code will
   * also be corrected. The result is pretty-printed.
   *
   ...
   *
   * <p>Usage: <tt>java XHTMLWriter &lt;source file&gt; &lt;target file&gt;</tt>
   *
   ...
   *
   * <p>This filter relies on known flaws of the HTMLWriter. It is known to work with Java 1.4, but
