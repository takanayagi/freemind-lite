 ...
 * <p>
 * The result will be a valid XML file, but it is not granted that the file will really be XHTML 1.0
 * transitional conform. The basic purpose of this class is to give an XSL processor access to plain
 * HTML files.
 * 
...
public class XHTMLWriter extends FixedHTMLWriter {
	...
	/**
	 * Start the writing process. An XML and DOCTYPE header will be written prior to the XHTML
	 * output.
	 */
	...
	/**
	 * Read HTML from the Reader, and send XHTML to the writer. Common mistakes in the HTML code
	 * will also be corrected. The result is pretty-printed.
	 * 
	...
	/**
	 * This FilterWriter will convert the output of Swing's HTMLWriter to XHTML format. This is done
	 * by converting tags like &lt;br&gt; to &lt;br&nbsp;/&gt;. Also, special characters in tag
	 * attributes are escaped.
	 * <p>
	 * This filter relies on known flaws of the HTMLWriter. It is known to work with Java 1.4, but
	 * might not work with future Java releases.
	 */
