 ...
 */
/*
 * Created on 12.07.2005 Copyright (C) 2005-2008 Dimitri Polivaev, Christian Foltin
 */
...
public class Resources implements TextTranslator {
	...
	public HashMap<String, String> getCountryMap() {
		if (countryMap == null) {
			String[] countryMapArray = new String[] {"de", "DE", "en", "UK", "en", "US", "es", "ES",
					...
					"NL", "no", "NO", "pt", "PT", "ru", "RU", "sl", "SI", "uk", "UA", "zh", "CN"};
	...
	public String createThumbnailFileName(File baseFileName) {
		return baseFileName.getParent() + File.separatorChar + "." // hidden
				+ baseFileName.getName().replaceFirst(FreeMindCommon.FREEMIND_FILE_EXTENSION + "$",
						".png");
	}
