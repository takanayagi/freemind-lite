...
public abstract class LineAdapter implements MindMapLine {
	...
	/**
	 * As this color is static but used in at least three different objects (edges, clouds and
	 * links), the abstract mechanism was chosen. The derived classes set and get the static
	 * instance variable.
	 */
