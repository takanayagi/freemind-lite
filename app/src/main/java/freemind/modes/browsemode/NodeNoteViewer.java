/*
 * FreeMind - A Program for creating and viewing Mindmaps Copyright (C) 2000-2006 Christian Foltin
 * and others See COPYING for Details
 *
 ...
 * 
 */
public class NodeNoteViewer extends NodeNoteBase implements NodeSelectionListener {
	...
	protected void setStateIcon(MindMapNode node, boolean enabled) {
		...
		if (noteIcon == null) {
			noteIcon = freemind.view.ImageFactory.getInstance()
					.createUnscaledIcon(mBrowseController.getResource("images/knotes.png"));
		}
