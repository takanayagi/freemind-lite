...
/**
 * This class creates all the modes that are available. To add your own mode, simply import it, and
 * create it in getAllModes() (just do the same whats done with MindMapMode). Thats all!
 */
