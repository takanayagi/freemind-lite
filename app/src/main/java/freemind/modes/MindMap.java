...
public interface MindMap extends TreeModel {
	...
	/**
	 * Returns a string that may be given to the modes restore() to get this map again. The Mode
	 * must take care that two different maps don't give the same restoreable key.
	 */
	 ...
	 */
	 interface MapSourceChangedObserver {
		 ...
		 *         returns true, then the next change on disk is reported as well. If it returns
		 *         false, the next changes will be ignored until the map is saved.
		 * @throws Exception
		 */
	 ...
	 *        registered, unregistered at time t, and register again at time t+s, you should specify
	 *        t here. If there was an event in between t and t+s, and event is issued directly.
	 */
	...
	MindMapNode loadTree(Tools.ReaderCreator pReaderCreator,
