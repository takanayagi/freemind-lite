...
public class FreeMindAwtFileDialog extends FileDialog implements FreeMindFileDialog {
	...
	private static final String APPLE_AWT_FILE_DIALOG_FOR_DIRECTORIES =
	 ...
	 * 
	 * @see
	 * freemind.modes.FreeMindFileDialog#addChoosableFileFilter(javax.swing.filechooser.FileFilter)
	 */
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Dir '" + dialog.getDirectory() + "', File: '" + dialog.getFile()
