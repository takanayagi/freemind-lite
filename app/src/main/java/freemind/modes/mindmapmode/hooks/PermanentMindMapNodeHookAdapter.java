 ...
 *
 * <p>This is a specialization adapted to the mindmap mode. As currently, nearly all hooks belong to
...
public class PermanentMindMapNodeHookAdapter extends PermanentNodeHookAdapter {
  ...
  protected PermanentNodeHook propagate(MindMapNode child) {
    PermanentNodeHook hook =
        (PermanentNodeHook) getMindMapController().createNodeHook(getName(), child);
    // invocation:
