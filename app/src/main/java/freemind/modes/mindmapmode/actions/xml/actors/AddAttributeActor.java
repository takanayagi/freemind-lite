...
public class AddAttributeActor extends XmlActorAdapter {
	...
	public void act(XmlAction action) {
		if (action instanceof AddAttributeAction addAttributeAction) {
			...
			Attribute newAttribute =
					new Attribute(addAttributeAction.getName(), addAttributeAction.getValue());
	...
	public ActionPair getActionPair(MindMapNode selected, Attribute pAttribute) {
		AddAttributeAction setAttributeAction = getAddAttributeAction(selected, pAttribute);
		RemoveAttributeAction undoAddAttributeAction =
				getXmlActorFactory().getRemoveAttributeActor().getRemoveAttributeAction(selected,
						selected.getAttributeTableLength());
	 ...
	 * @return
	 */
	public AddAttributeAction getAddAttributeAction(MindMapNode pSelected, Attribute pAttribute) {
