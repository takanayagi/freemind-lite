...
public class ChangeArrowsInArrowLinkActor extends XmlActorAdapter {
  ...
  /** */
  private ActionPair getActionPair(
      MindMapArrowLink arrowLink2, boolean hasStartArrow2, boolean hasEndArrow2) {
    return new ActionPair(
        createArrowLinkArrowXmlAction(arrowLink2, hasStartArrow2, hasEndArrow2),
        createArrowLinkArrowXmlAction(
            arrowLink2, arrowLink2.getStartArrow(), arrowLink2.getEndArrow()));
  }
  ...
  private ArrowLinkArrowXmlAction createArrowLinkArrowXmlAction(
    ...
    return createArrowLinkArrowXmlAction(
        arrowLink, (hasStartArrow) ? "Default" : "None", (hasEndArrow) ? "Default" : "None");
  }

  private ArrowLinkArrowXmlAction createArrowLinkArrowXmlAction(
      MindMapArrowLink arrowLink, String hasStartArrow, String hasEndArrow) {
