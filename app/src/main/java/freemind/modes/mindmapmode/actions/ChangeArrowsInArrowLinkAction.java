 ...
 */
/*
 * $Id: ChangeArrowsInArrowLinkAction.java,v 1.16.10.1 08.10.2004 23:12:57 christianfoltin Exp $
 */
...
public class ChangeArrowsInArrowLinkAction extends MindmapAction {
	...
	public ChangeArrowsInArrowLinkAction(MindMapController controller, String text, String iconPath,
			MindMapArrowLinkModel arrowLink, boolean hasStartArrow, boolean hasEndArrow) {
