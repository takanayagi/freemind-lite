...
public class EditAction extends MindmapAction {
  ...
  public void edit(KeyEvent e, boolean addNew, boolean editLong) {
    ...
    if (selectedNodeView != null) {
      if (e == null || !addNew) {
        ...
        mMindMapController.addNew(
            mMindMapController.getSelected(), MindMapController.NEW_SIBLING_BEHIND, e);
      }
      if (e != null) {
        e.consume();
      }
  ...
  public void edit(
    ...
    if (editInternalWysiwyg) {
      EditNodeWYSIWYG editNodeWYSIWYG =
          new EditNodeWYSIWYG(
              node,
              text,
              firstEvent,
    ...
    if (editExternal) {
      EditNodeExternalApplication editNodeExternalApplication =
          new EditNodeExternalApplication(
              node,
              text,
              firstEvent,
              mMindMapController,
