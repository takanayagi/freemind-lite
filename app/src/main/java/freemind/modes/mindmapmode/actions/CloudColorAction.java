...
public class CloudColorAction extends MindmapAction {
	...
	public void actionPerformed(ActionEvent e) {
		...
		Color color = Controller.showCommonJColorChooserDialog(controller.getView().getSelected(),
				controller.getText("choose_cloud_color"), selectedColor);
		if (color == null) {
			return;
		}
	...
	public boolean isEnabled(JMenuItem item, Action action) {
		return super.isEnabled(item, action) && (controller != null)
				&& (controller.getSelected() != null)
