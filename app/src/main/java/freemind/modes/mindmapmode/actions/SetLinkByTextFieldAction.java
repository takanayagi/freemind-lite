 ...
 */
/*
 * $Id: SetLinkByTextFieldAction.java,v 1.16.10.1 12.10.2004 22:18:45 christianfoltin Exp $
 */
...
public class SetLinkByTextFieldAction extends MindmapAction {
	...
	public void actionPerformed(ActionEvent e) {
		String inputValue = JOptionPane.showInputDialog(controller.getView().getSelected(),
				controller.getText("edit_link_manually"), controller.getSelected().getLink());
		if (inputValue != null) {
