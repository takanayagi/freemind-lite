...
public class RevertActor extends XmlActorAdapter {
	...
	public void openXmlInsteadOfMap(String xmlFileContent) {
		try {
			...
			RevertXmlAction undoAction =
					createRevertXmlAction(getExMapFeedback().getMap(), null, null);
			execute(new ActionPair(doAction, undoAction));
		} catch (IOException e) {
	 ...
	 *        null.
	 */
	public RevertXmlAction createRevertXmlAction(String xmlPackedFile, String fileName,
			String filePrefix) {
