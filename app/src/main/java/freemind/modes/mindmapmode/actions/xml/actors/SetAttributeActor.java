...
public class SetAttributeActor extends XmlActorAdapter {
	...
	public ActionPair getActionPair(MindMapNode selected, int pPosition, Attribute pAttribute) {
		SetAttributeAction setAttributeAction =
				getSetAttributeAction(selected, pPosition, pAttribute);
		SetAttributeAction undoSetAttributeAction =
				getSetAttributeAction(selected, pPosition, selected.getAttribute(pPosition));
		return new ActionPair(setAttributeAction, undoSetAttributeAction);
	}

	public void setAttribute(MindMapNode pSelected, int pPosition, Attribute pAttribute) {
	 ...
	 * @return
	 */
	public SetAttributeAction getSetAttributeAction(MindMapNode pSelected, int pPosition,
