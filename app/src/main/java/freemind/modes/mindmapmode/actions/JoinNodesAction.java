...
public class JoinNodesAction extends MindmapAction {
  ...
  public void actionPerformed(ActionEvent e) {
    MindMapNode selectedNode = controller.getView().getSelected().getModel();
    ArrayList<MindMapNode> selectedNodes = controller.getView().getSelectedNodesSortedByY();
  ...
  static final Pattern BODY_START = Pattern.compile("<body>", Pattern.CASE_INSENSITIVE);
  static final Pattern BODY_END = Pattern.compile("</body>", Pattern.CASE_INSENSITIVE);

  private String addContent(
      String content, boolean isHtml, String nodeContent, boolean isHtmlNode) {
    if (isHtml) {
