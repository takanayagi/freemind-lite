 ...
 */
/*
 * $Id: ApplyPatternAction.java,v 1.16.10.1 05.10.2004 11:32:42 christianfoltin Exp $
 */
...
public class ApplyPatternAction extends NodeGeneralAction implements SingleNodeOperation {
	...
	public void apply(MindMapMapModel map, MindMapNodeModel node) {
		StylePatternFactory.applyPattern(node, mpattern, getMindMapController().getPatternsList(),
				getMindMapController().getPlugins(), getMindMapController());
	}
