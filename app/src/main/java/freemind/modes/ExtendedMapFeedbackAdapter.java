...
public abstract class ExtendedMapFeedbackAdapter extends MapFeedbackAdapter
	...
	public void toggleFolded() {
		getActorFactory().getToggleFoldedActor()
	...
	public void applyPattern(MindMapNode pNode, Pattern pPattern) {
		StylePatternFactory.applyPattern(pNode, pPattern, Collections.emptyList(),
	...
	@Override
	public void changeArrowsOfArrowLink(MindMapArrowLink pArrowLink, boolean pHasStartArrow,
			boolean pHasEndArrow) {
	...
	public void setArrowLinkEndPoints(MindMapArrowLink pLink, Point pStartPoint, Point pEndPoint) {
		getActorFactory().getChangeArrowLinkEndPointsActor().setArrowLinkEndPoints(pLink,
	...
	@Override
	public boolean paste(Transferable pT, MindMapNode pTarget, boolean pAsSibling,
			boolean pIsLeft) {
		return mActorFactory.getPasteActor().paste(pT, pTarget, pAsSibling, pIsLeft);
	}

	@Override
	public void addHook(MindMapNode pFocussed, List<MindMapNode> pSelecteds, String pHookName,
			Properties pHookProperties) {
		getActorFactory().getAddHookActor().addHook(pFocussed, pSelecteds, pHookName,
				pHookProperties);
	}
