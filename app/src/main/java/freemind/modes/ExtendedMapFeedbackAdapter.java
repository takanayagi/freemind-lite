/*
 * FreeMind - A Program for creating and viewing Mindmaps Copyright (C) 2000-2014 Joerg Mueller,
...
public abstract class ExtendedMapFeedbackAdapter extends MapFeedbackAdapter
  ...
  private static final class DummyTransferable implements Transferable {
    ...
    @Override
    public Object getTransferData(DataFlavor pFlavor) throws UnsupportedFlavorException {
  ...
  @Override
  public void insertNodeInto(MindMapNode pNewNode, MindMapNode pParent, int pIndex) {
   ...
   */
  @Override
  public Transferable copy(List<? extends MindMapNode> pNodeList, boolean pSaveInvisible) {
    return new DummyTransferable();
  }
   ...
   */
  @Override
  public MapFeedback load(File pFile) throws IOException, XMLParseException, URISyntaxException {
    return this;
  }
  ...
  @Override
  public MindMapNode addNewNode(MindMapNode pParent, int pIndex, boolean pNewNodeIsLeft) {
  ...
  public void toggleFolded() {
    getActorFactory()
        .getToggleFoldedActor()
        .toggleFolded(getViewAbstraction().getSelectedNodesSortedByY().listIterator());
  }
  ...
  public void applyPattern(MindMapNode pNode, Pattern pPattern) {
    StylePatternFactory.applyPattern(
        pNode, pPattern, Collections.emptyList(), Collections.emptySet(), this);
  }
  ...
  public void changeArrowsOfArrowLink(
      MindMapArrowLink pArrowLink, boolean pHasStartArrow, boolean pHasEndArrow) {
    getActorFactory()
        .getChangeArrowsInArrowLinkActor()
        .changeArrowsOfArrowLink(pArrowLink, pHasStartArrow, pHasEndArrow);
  }
  ...
  @Override
  public void setArrowLinkEndPoints(MindMapArrowLink pLink, Point pStartPoint, Point pEndPoint) {
    getActorFactory()
        .getChangeArrowLinkEndPointsActor()
        .setArrowLinkEndPoints(pLink, pStartPoint, pEndPoint);
  }
  ...
  @Override
  public boolean paste(Transferable pT, MindMapNode pTarget, boolean pAsSibling, boolean pIsLeft) {
    return mActorFactory.getPasteActor().paste(pT, pTarget, pAsSibling, pIsLeft);
  }

  @Override
  public void addHook(
      MindMapNode pFocussed,
      List<MindMapNode> pSelecteds,
      String pHookName,
  ...
  @Override
  public void moveNodePosition(MindMapNode pNode, int pVGap, int pHGap, int pShiftY) {
