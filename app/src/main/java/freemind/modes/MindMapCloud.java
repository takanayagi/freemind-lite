...
public interface MindMapCloud extends MindMapLine {
	 ...
	 * 
	 * Cloud iterative level is kept in CloudAdapter object. It is automatically calculated during
	 ...
	 * 
	 * When some parent node gets or loses its cloud, it should call this Method, with deltaLevel
	 * equal to 1 or -1.
	 */
