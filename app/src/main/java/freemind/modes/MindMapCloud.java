...
public interface MindMapCloud extends MindMapLine {
  ...
  /**
   * Describes the color of the exterior of the cloud. Normally, this color is derived from the
   * interior color.
   */
   ...
   *
   * <p>Cloud iterative level is kept in CloudAdapter object. It is automatically calculated during
   * the first call of this Method (delayed initialisation).
   */
   ...
   *
   * <p>When some parent node gets or loses its cloud, it should call this Method, with deltaLevel
   * equal to 1 or -1.
   */
