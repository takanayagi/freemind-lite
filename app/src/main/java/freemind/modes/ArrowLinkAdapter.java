...
public abstract class ArrowLinkAdapter extends LinkAdapter implements MindMapArrowLink {
  ...
  public Point getStartInclination() {
    if (startInclination == null) return null;
    return new Point(startInclination);
  }

  public Point getEndInclination() {
    if (endInclination == null) return null;
  ...
  public Object clone() {
    ...
    arrowLink.startInclination =
        (startInclination == null) ? null : new Point(startInclination.x, startInclination.y);
    arrowLink.endInclination =
        (endInclination == null) ? null : new Point(endInclination.x, endInclination.y);
