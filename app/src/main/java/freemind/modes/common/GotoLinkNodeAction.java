...
public class GotoLinkNodeAction extends AbstractAction {
	...
	public GotoLinkNodeAction(ModeController controller, MindMapNode source) {
		super(controller.getText("goto_link_node_action"), freemind.view.ImageFactory.getInstance()
		...
		if (source != null) {
			...
			putValue(Action.NAME, controller.getText("follow_graphical_link") + adaptedText);
