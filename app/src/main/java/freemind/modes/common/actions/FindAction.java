...
public class FindAction extends FreemindAction {
  ...
  void displayDialog() {
    ...
    contentPane.add(
        new JLabel(controller.getText("find_what")),
  ...
  private boolean find(
      LinkedList<MindMapNode> nodes, Collection<String> subterms, boolean caseSensitive) {
