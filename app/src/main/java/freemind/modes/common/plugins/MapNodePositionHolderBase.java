/*
 * FreeMind - A Program for creating and viewing Mindmaps Copyright (C) 2000-2012 Joerg Mueller,
...
/**
 * This base class is free of openstreetmap and similar classes. Thus, it doesn't know much about
 * its position.
 * 
 * @author foltin
 * @date 16.08.2012
...
public class MapNodePositionHolderBase extends PermanentNodeHookAdapter {
	...
	protected static final String XML_STORAGE_MAP_TOOLTIP_LOCATION =
			"XML_STORAGE_MAP_TOOLTIP_LOCATION";
	protected static final String NODE_MAP_SHOW_TOOLTIP = "node_map_show_tooltip";
	public static final String TILE_SOURCE_MAP_QUEST_OPEN_MAP =
			"plugins.map.FreeMindMapController.MapQuestOpenMap";
	public static final String TILE_SOURCE_TRANSPORT_MAP =
			"plugins.map.FreeMindMapController.TransportMap";
	public static final String TILE_SOURCE_MAPNIK =
	...
	public static ImageIcon getMapLocationIcon() {
		...
		if (sMapLocationIcon == null) {
			sMapLocationIcon = freemind.view.ImageFactory.getInstance().createUnscaledIcon(
					Resources.getInstance().getResource("images/map_location.png"));
		}
	...
	public String[] getBarePosition() {
		return new String[] {mValues.get(XML_STORAGE_POS_LAT),
				...
				mValues.get(XML_STORAGE_MAP_LON), mValues.get(XML_STORAGE_ZOOM),
