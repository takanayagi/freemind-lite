...
public abstract class MapFeedbackAdapter implements MapFeedback, ViewFeedback {
   ...
   * (non-Javadoc)
   *
   * @see freemind.modes.MapFeedback#fireNodePreDeleteEvent(freemind.modes.MindMapNode )
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see freemind.modes.MapFeedback#fireNodePostDeleteEvent(freemind.modes.MindMapNode,
   ...
   * (non-Javadoc)
   *
   * @see freemind.modes.MapFeedback#firePreSaveEvent(freemind.modes.MindMapNode)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see freemind.modes.MapFeedback#paste(freemind.modes.MindMapNode, freemind.modes.MindMapNode)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see freemind.modes.MapFeedback#invokeHooksRecursively(freemind.modes.MindMapNode ,
   * freemind.modes.MindMap)
   */
  @Override
  public void invokeHooksRecursively(MindMapNode pNode, MindMap pModel) {
    for (Iterator<? extends MindMapNode> i = pNode.childrenUnfolded(); i.hasNext(); ) {
  ...
  /**
   * This class sortes nodes by ascending depth of their paths to root. This is useful to assure
   * that children are cutted <b>before </b> their fathers!!!.
   *
   * <p>Moreover, it sorts nodes with the same depth according to their position relative to each
   * other.
   */
