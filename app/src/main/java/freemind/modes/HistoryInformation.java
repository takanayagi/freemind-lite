...
/**
 * Here, the creation and modification times of objects (by now, only for nodes) are stored.
 *
 * <p>The storage as longs is preferred as they are normally inlined by the Java compiler.
 *
 * @author foltin
 */
