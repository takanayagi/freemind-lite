...
public class XMLElementAdapter extends XMLElement {
  ...
  protected XMLElementAdapter(
      MapFeedback pMapFeedback,
      Vector<ArrowLinkAdapter> arrowLinkAdapters,
      HashMap<String, NodeAdapter> IDToTarget) {
   ...
   * Thus, the instance of a node can be changed after the creation. (At the moment, relevant for
   * encrypted nodes).
   */
   ...
   *
   * <p>Case I: Source+Destination are pasted (Ia: cut, Ib: copy) Case II: Source is pasted,
   * Destination remains unchanged in the map (IIa: cut, IIb: copy) Case III: Destination is pasted,
   * Source remains unchanged in the map (IIIa: cut, IIIb: copy)
   */
