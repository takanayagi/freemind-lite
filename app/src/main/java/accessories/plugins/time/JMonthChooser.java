/*
 * JMonthChooser.java - A bean for choosing a month Copyright (C) 2004 Kai Toedter kai@toedter.com
 * www.toedter.com
 *
...
public class JMonthChooser extends JPanel implements ItemListener, ChangeListener {
	 ...
	 * @param select true, if the month should be selected in the combo box.
	 */
	...
	/**
	 * Sets the month. This is a bound property. Values are valid between 0 (January) and 11
	 * (December). A value < 0 will be treated as 0, a value > 11 will be treated as 11.
	 * 
	 * @param newMonth the new month value
	 * 
	 * @see #getMonth
	...
	/**
	 * Convenience method set a year chooser. If set, the spin for the month buttons will spin the
	 * year as well
	 * 
