/*
 * JSpinField.java - A spin field using a JSpinner (JDK 1.4) Copyright (C) 2004 Kai Toedter
 * kai@toedter.com www.toedter.com
 *
...
public class JSpinField extends JPanel
  ...
  /**
   * After any user input, the value of the textfield is proofed. Depending on being an integer, the
   * value is colored green or red.
   *
  ...
  /**
   * After any user input, the value of the textfield is proofed. Depending on being an integer, the
   * value is colored green or red. If the textfield is green, the enter key is accepted and the new
   * value is set.
   *
