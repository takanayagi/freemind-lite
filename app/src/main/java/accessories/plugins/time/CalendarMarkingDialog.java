...
public class CalendarMarkingDialog extends JDialog
    ...
    if (jContentPane == null) {
      ...
      layout.setVerticalGroup(
          layout
              .createSequentialGroup()
              .addGroup(
                  layout.createParallelGroup().addComponent(nameLabel).addComponent(nameField))
              .addGroup(
                  layout
                      .createParallelGroup()
                      .addComponent(repetitionTypeLabel)
              ...
              .addGroup(
                  layout
                      ...
                      .addComponent(firstOccurence))
              .addGroup(
                  layout.createParallelGroup().addComponent(startDateLabel).addComponent(startDate))
              .addGroup(
                  layout.createParallelGroup().addComponent(endDateLabel).addComponent(endDate))
              .addGroup(
                  layout
                      .createParallelGroup()
                      .addComponent(markerColorLabel)
                      .addComponent(markerColor))
              .addGroup(
                  layout.createParallelGroup().addComponent(examplesLabel).addComponent(mTextArea))
              .addGroup(
  ...
  private void showExamples() {
    ...
    for (Calendar calendar : nEntries) {
      text.append(DateFormat.getDateInstance(DateFormat.SHORT).format(calendar.getTime()))
          .append("\n");
    }
