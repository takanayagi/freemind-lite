...
public class CalendarMarkingDialog extends JDialog
	...
	private static final String WINDOW_PREFERENCE_STORAGE_PROPERTY =
			"CalendarMarkingDialog_WindowPosition";
	...
	public static void main(String[] args) {
		...
		final String MARKINGS =
				"<?xml version=\"1.0\" encoding=\"UTF-8\"?><calendar_markings><calendar_marking name=\"bla\" color=\"#cc0099\" start_date=\"1443650400000\" end_date=\"1447801200000\" repeat_type=\"yearly\" repeat_each_n_occurence=\"1\" first_occurence=\"2\"/></calendar_markings>";
		...
		if (jContentPane == null) {
			...
			layout.setHorizontalGroup(layout.createSequentialGroup()
					.addGroup(layout.createParallelGroup().addComponent(nameLabel)
							...
							.addComponent(firstOccurenceLabel).addComponent(startDateLabel)
							.addComponent(endDateLabel).addComponent(markerColorLabel)
							.addComponent(examplesLabel).addComponent(okButton))
					.addGroup(layout.createParallelGroup().addComponent(nameField)
							.addComponent(repetitionType).addComponent(repeatEachNOccurence)
							.addComponent(firstOccurence).addComponent(startDate)
							.addComponent(endDate).addComponent(markerColor).addComponent(mTextArea)
							.addComponent(cancelButton)));
			layout.setVerticalGroup(layout.createSequentialGroup()
					.addGroup(layout.createParallelGroup().addComponent(nameLabel)
							.addComponent(nameField))
					.addGroup(layout.createParallelGroup().addComponent(repetitionTypeLabel)
							.addComponent(repetitionType))
					.addGroup(layout.createParallelGroup().addComponent(repeatEachNOccurenceLabel)
							.addComponent(repeatEachNOccurence))
					.addGroup(layout.createParallelGroup().addComponent(firstOccurenceLabel)
							.addComponent(firstOccurence))
					.addGroup(layout.createParallelGroup().addComponent(startDateLabel)
							.addComponent(startDate))
					.addGroup(layout.createParallelGroup().addComponent(endDateLabel)
							.addComponent(endDate))
					.addGroup(layout.createParallelGroup().addComponent(markerColorLabel)
							.addComponent(markerColor))
					.addGroup(layout.createParallelGroup().addComponent(examplesLabel)
	...
	public void propertyChange(PropertyChangeEvent pEvt) {
		if (pEvt.getNewValue() instanceof Calendar cal
				&& pEvt.getSource() instanceof JSwitchableCalendar) {
			if (!ignoreNextEvent) {
