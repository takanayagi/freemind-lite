/*
 * JCalendar.java - A bean for choosing a date Copyright (C) 2004 Kai Toedter kai@toedter.com
 * www.toedter.com
 *
...
public class JCalendar extends JPanel implements PropertyChangeListener {
	...
	public void propertyChange(PropertyChangeEvent evt) {
		...
		try {
			// System.out.println("Property change in " +this.getClass().getSimpleName() + "
			// of type " + evt.getPropertyName());
			if (calendar != null) {
	...
	private void setCalendar(Calendar c, boolean update) {
		...
		calendar = c;
		// fc, 25.6.2014: always fire the change event (formerly, there was oldCalendar,
		// but sometimes,
		// they are equal.
