...
public class ExportToOoWriter extends ExportHook {
	 ...
	 */
	private boolean applyXsltFile(String xsltFileName, StringWriter writer, Result result)
			throws IOException {
	...
	private boolean copyFromResource(String fileName, OutputStream out) {
		...
		try {
			...
			logger.severe("File not found or could not be copied. " + "Was earching for " + fileName
