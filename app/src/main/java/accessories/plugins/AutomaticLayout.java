...
public class AutomaticLayout extends PermanentMindMapNodeHookAdapter {
  ...
  public static class Registration implements HookRegistration {
    ...
    public void register() {
      ...
      mAutomaticLayoutPropertyContributor = new AutomaticLayoutPropertyContributor(modeController);
  ...
  public static class StylePatternListProperty extends PropertyBean
    ...
    public void setValue(String value) {
      ...
      for (Pattern pattern : resultPatterns.getListChoiceList()) {
        mDefaultListModel.addElement(
            mTranslator.getText("level" + j)
                + ": "
    ...
    public void valueChanged(ListSelectionEvent e) {
      ...
      final ChooseFormatPopupDialog formatDialog =
          new ChooseFormatPopupDialog(
              mindMapController.getFrame().getJFrame(),
              mindMapController,
              "accessories/plugins/AutomaticLayout.properties_StyleDialogTitle",
  ...
  private static final class AutomaticLayoutPropertyContributor
    ...
    public List<PropertyControl> getControls(TextTranslator pTextTranslator) {
      ...
      controls.add(
          new OptionPanel.NewTabProperty(
      ...
      controls.add(
          new StylePatternListProperty(
              "level", AUTOMATIC_FORMAT_LEVEL, pTextTranslator, modeController));
      return controls;
    }
  }
  ...
  private void setStyle(MindMapNode node) {
    logger.finest(
        "updating node id=" + node.getObjectId(getMindMapController()) + " and text:" + node);
