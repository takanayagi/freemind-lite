...
public class ManagePatterns extends MindMapHookAdapter {
  ...
  public void startupMapHook() {
    ...
    ManagePatternsPopupDialog formatDialog =
        new ManagePatternsPopupDialog(frame.getJFrame(), getMindMapController());
    // formatDialog.pack();
    ...
    if (formatDialog.getResult() == ChooseFormatPopupDialog.OK) {
      try {
        ...
        StylePatternFactory.savePatterns(
            new FileWriter(patternFile), formatDialog.getPatternList());
