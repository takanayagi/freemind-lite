...
/**
 * Taken from
 * http://stackoverflow.com/questions/2316563/how-can-i-sort-java-jtable-with-an-empty-row-and-force-the-empty-row-always-be-l
 * 
 * @date 11.03.2015
 */
public class NewLineTable extends ScalableJTable {
	...
	public void setValueAt(Object aValue, int row, int column) {
		if (row < super.getRowCount()) {
			...
			final int position =
					((AttributeTableModel) getModel()).addAttributeHolder(attribute, true);
