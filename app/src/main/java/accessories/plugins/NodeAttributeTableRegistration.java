...
public class NodeAttributeTableRegistration
	...
	public void register() {
		...
		for (Iterator<TableColumnOrder> it = props.getListTableColumnOrderList().iterator(); it
			...
			keys.add(new SortKey(setting.getColumnIndex(),
					SortOrder.valueOf(setting.getColumnSorting())));
		}
	...
	public void showAttributeTablePanel() {
		...
		controller.getController().insertComponentIntoSplitPane(mAttributeViewerComponent,
