...
public class ExportDialog extends JFrame {
    ...
    public void actionPerformed(ActionEvent e) {
      if (!cancel) {
        ...
        try {
          xe.transForm(
              parent.xmlFile,
              new File(parent.fieldXsltFileName.getText()),
      ...
      mController
          .getFrame()
          .setProperty(
              ACCESSORIES_PLUGINS_UTIL_XSLT_EXPORT_DIALOG_STORE_XSLT, fieldXsltFileName.getText());
      mController
          .getFrame()
          .setProperty(
  ...
  public ExportDialog(File nxmlFile, ModeController pController) {
    ...
    String lastXsltFileName =
        mController.getFrame().getProperty(ACCESSORIES_PLUGINS_UTIL_XSLT_EXPORT_DIALOG_STORE_XSLT);
