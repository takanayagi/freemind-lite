...
public class ClonePlugin extends PermanentMindMapNodeHookAdapter
	...
	/**
	 * Includes the original node. This is a cached list with the MindMapNodes belonging to the
	 * {@link ClonePlugin#mCloneNodeIds mCloneNodeIds}.
	 */
	...
	private void registerPlugin() {
		...
		logger.fine("Invoke shadow class with orig: " + printNodeId(originalNode) + " and clones "
