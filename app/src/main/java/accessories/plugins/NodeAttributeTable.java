...
public class NodeAttributeTable extends MindMapNodeHookAdapter {
  ...
  private NodeAttributeTableRegistration getRegistration() {
    NodeAttributeTableRegistration registration =
        (NodeAttributeTableRegistration) this.getPluginBaseClass();
    return registration;
  }
  ...
  private void setShowSplitPaneProperty(boolean pValue) {
    getMindMapController()
        .setProperty(FreeMind.RESOURCES_SHOW_ATTRIBUTE_PANE, pValue ? "true" : "false");
  }
}
