...
public class ChooseFormatPopupDialog extends JDialog implements TextTranslator, KeyListener {
  ...
  private javax.swing.JPanel getJContentPane() {
    if (jContentPane == null) {
       ...
       */
      jContentPane.add(
          new JScrollPane(getStylePatternFrame()),
  ...
  private Component getDemoFrame() {
    if (mDemoFrame == null) {
      ...
      Tools.StringReaderCreator readerCreator =
  ...
  private Component getStylePatternFrame() {
    if (mStylePatternFrame == null) {
      mStylePatternFrame =
          new StylePatternFrame(this, mController, StylePatternFrameType.WITHOUT_NAME_AND_CHILDS) {
