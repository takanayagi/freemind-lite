...
public class ChooseFormatPopupDialog extends JDialog implements TextTranslator, KeyListener {
	...
	private static final String WINDOW_PREFERENCE_STORAGE_PROPERTY =
			"accessories.plugins.dialogs.ChooseFormatPopupDialog.window_storage";
	 ...
	 * 
	 */
	public ChooseFormatPopupDialog(JFrame caller, MindMapController controller, String dialogTitle,
			Pattern pattern, MindMapNode pNode) {
		super(caller);
	...
	private javax.swing.JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			/*
			 * public GridBagConstraints(int gridx, int gridy, int gridwidth, int gridheight, double
			...
			jContentPane.add(new JScrollPane(getStylePatternFrame()),
					new GridBagConstraints(0, 0, 2, 1, 2.0, 8.0, GridBagConstraints.WEST,
			...
			jContentPane.add(getJOKButton(),
					new GridBagConstraints(0, 2, 1, 1, 1.0, 0.0, GridBagConstraints.EAST,
							GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
			jContentPane.add(getJCancelButton(),
					new GridBagConstraints(1, 2, 1, 1, 1.0, 0.0, GridBagConstraints.EAST,
							GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		...
		if (mStylePatternFrame == null) {
			mStylePatternFrame = new StylePatternFrame(this, mController,
				...
				public void propertyChange(PropertyChangeEvent pEvt) {
					...
					mDemoNodeMapFeedback.select(mDemoNode,
							Tools.getVectorWithSingleElement(mDemoNode));
