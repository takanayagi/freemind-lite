...
public class ManagePatternsPopupDialog extends JDialog implements TextTranslator, KeyListener {
  ...
  private final class PatternListSelectionListener implements ListSelectionListener {
    ...
    public void valueChanged(ListSelectionEvent e) {
      if (e.getValueIsAdjusting() || mIsDragging) return;
      // save old list:
  ...
  private javax.swing.JPanel getJContentPane(List<Pattern> patternList) {
    if (jContentPane == null) {
      ...
      mList.setCellRenderer(
          new DefaultListCellRenderer() {
            @Override
            public Component getListCellRendererComponent(
                JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
              return super.getListCellRendererComponent(
                  list, ((Pattern) value).getName(), index, isSelected, cellHasFocus);
            }
          });
      mList.addMouseMotionListener(
      ...
      mStylePatternFrame =
          new StylePatternFrame(this, mController, StylePatternFrameType.WITH_NAME_AND_CHILDS);
      ...
      jContentPane.add(
          new ButtonBarBuilder()
              .addGlue()
              .addButton(getJCancelButton())
              .addButton(getJOKButton())
              .build(),
          new GridBagConstraints(
              1,
              1,
  ...
  private void insertPatternFromNode(ActionEvent actionEvent) {
    ...
    setLastSelectedPattern(null);
    Pattern newPattern =
        StylePatternFactory.createPatternFromSelected(
          ...
          if (otherPattern.getName().equals(newPatternName)) {
            ...
            int selection =
                JOptionPane.showOptionDialog(
                    ...
                    mController.getText("ManagePatternsPopupDialog.DuplicateNameMessage"),
