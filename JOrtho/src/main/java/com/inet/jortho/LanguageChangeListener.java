...
/**
 * A language change event gets fired whenever the language is changed. You can register a
 * LanguageChangeListener in the class SpellChecker.
 *
...
public interface LanguageChangeListener extends EventListener {
  ...
  /**
   * This method gets called when the language is changed. This occurs if the user selects another
