...
/**
 * Interface to be implemented by a user of the spellchecker that provides the ability to show/log
 * errors and information messages as required by applications using the dictionary
 *
