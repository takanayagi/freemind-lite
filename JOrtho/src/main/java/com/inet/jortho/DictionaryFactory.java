...
/**
 * With the DictionaryFactory you can create / load a Dictionary. A Dictionary is list of word with
 * an API for searching. The list is saved internal as a tree.
 *
 * @see Dictionary
...
class DictionaryFactory {
  ...
  /**
   * Load the directory from a compressed list of words with UTF8 encoding. The words must be
   * delimited with newlines. This method can be called multiple times.
   *
  ...
  /**
   * Create from the data in this factory a Dictionary object. If there are no word added then the
   * Dictionary is empty. The Dictionary need fewer memory as the DictionaryFactory.
   *
  ...
  /** A node in the search tree. Every Node can include a list of NodeEntries */
