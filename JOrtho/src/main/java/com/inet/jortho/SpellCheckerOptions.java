...
/**
 * This class contains some options for spell checking. You can change it globally(see ({@link
 * SpellChecker#getOptions()})) or for every JTextComponent individually on registering.
 *
...
public class SpellCheckerOptions {
  ...
  /**
   * Set the maximum count of entries for the suggestion menu. The default is 15.
   *
  ...
  /**
   * Set the maximum count of entries for the suggestion list in the spell checker dialog. The
   * default is 15.
   *
  ...
  /**
   * Set whether the spell checker is case-sensitive. This only has an effect on the first letter of
   * a word. The default value is true.
   *
   * @param caseSensitive whether the spell checker is to be case-sensitive for the first letter of
   *     each word.
   */
  ...
  /**
   * Return whether the spell checker is case-sensitive. This only has an effect on the first letter
   * of a word.
   *
   ...
   * This is often used in a title or in names. The first word of a sentence will always ignore the
   * capitalization. The default is false.
   *
  ...
  /**
   * Return whether capitalized words should be correct if the word is in the dictionary as
   * lower-case.
   *
  ...
  /**
   * Set if words that are entirely in uppercase should be ignored for spell checking. This is most
   * often used for abbreviations such DNS or HTTP. The default value is true.
   *
   * @param ignore the new value
   */
  ...
  /**
   * Set if words that include a number in any position should be ignored for spell checking. The
   * default is false.
   *
   * @param ignore the new value
   */
  ...
  /**
   * Set if the disable menu item visible in the language menu. The default is false.
   *
