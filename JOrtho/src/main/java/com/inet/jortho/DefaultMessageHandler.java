...
/**
 * Default implementation of the message handler provider that shows the messages in Swing dialogs
 * and printing stack traces to the console
 *
...
public class DefaultMessageHandler implements MessageHandler {
   ...
   *
   * @param ownerFrame The frame that should own the Swing message dialogs (to avoid them shown
   *     behind and locking)
   */
  ...
  public void handleError(String title, String errorText, Throwable throwable) {
    ...
    JOptionPane.showMessageDialog(
        ownerFrame, throwable.toString(), title, JOptionPane.ERROR_MESSAGE);
  }
