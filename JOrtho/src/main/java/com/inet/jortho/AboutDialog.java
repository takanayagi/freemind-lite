...
class AboutDialog extends JDialog {
  ...
  AboutDialog(JDialog parent) {
    ...
    if (licensee != null && !licensee.isEmpty() && "Commercial License".equalsIgnoreCase(license)) {
      // Commercial License
      ...
      content.add(Utils.getLabel(copyright), gbc);
      JLabel link =
          Utils.getLabel("<html><u>https://www.inetsoftware.de/other-products/jortho</u></html>");
      ...
      link.addMouseListener(
          new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
              try {
                Desktop.getDesktop()
                    .browse(new URI("http://www.inetsoftware.de/other-products/jortho"));
              } catch (Exception ex) {
                ex.printStackTrace();
              }
            }
