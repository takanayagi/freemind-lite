...
class DictionaryEditDialog extends JDialog{
    ...
    /**
     * A hack for the layout manger to prevent that the dialog is too small to show the title line. The problem occur
     * only if there are small words in the list. With an empty list there are no problems.
     */
    @Override
     ...
     */
    private void loadWordList( DefaultListModel<String> model, HashSet<String> wordSet, Iterator<String> wordIterator ){
    ...
    private class ExportAction extends AbstractAction{
        ...
        public void actionPerformed(ActionEvent e){
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    Writer writer = new OutputStreamWriter(  new FileOutputStream( selectedFile ), StandardCharsets.UTF_8 );
