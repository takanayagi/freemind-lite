...
/**
 * This is a reference implementation of the interface {@link UserDictionaryProvider}. It save the
 * user dictionaries on the local disk as text files.
 *
...
public class FileUserDictionary implements UserDictionaryProvider {
  ...
  public FileUserDictionary(String fileBase) {
    ...
    if (!fileBase.isEmpty() && !fileBase.endsWith("/")) {
      fileBase += "/";
    }
