...
/**
 * An implementation of an Iterator which split a large text into lines. It is used to read words
 * lists.
 *
...
public class WordIterator implements Iterator<String> {
  ...
  /**
   * Load the directory from plain a list of words. The words must be delimited with newlines.
   *
