...
/**
 * This class hold one Suggestion for another spelling. Note: this class has a natural ordering that
...
final class Suggestion implements Comparable<Suggestion> {
  ...
  /**
   * Return a value that descript dissimilarity to the original word. A value of 0 means that the
   * value is 100% identical. This should not occur.
   *
