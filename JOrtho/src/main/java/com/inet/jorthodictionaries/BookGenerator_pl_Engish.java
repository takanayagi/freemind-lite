...
public class BookGenerator_pl_Engish extends BookGenerator {
  ...
  private void declensionNounF(String wikiText) {
    ...
    String[] suffixe = {
      "ba", "ca", "cha", "cza", /* "da", (excluding '''-zda''')*/ "dza", "dża", "fa", "ga", "ka",
      "la", "ła", "ma", /*"na", (excluding '''-sna''' and '''-zna''')*/ "pa", "ra", "sa",
      "sza", /*"ta", (excluding '''-sta''')*/ "wa", "za", "ża"
    };
  ...
  private void declensionAdjKi(String wikiText) {
    String[] suffixe = {
      "ki", "kie", "ka", "cy", "kie", "kiego", "kiej", "kich", "kiemu", "kim", "kiego", "ki", "kie",
      "ką", "kich", "kie", "kim", "kimi", "kiej", "kich"
    };
