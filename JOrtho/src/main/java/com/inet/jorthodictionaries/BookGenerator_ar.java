...
/**
 * The Arabic words can be garbage the view in Eclispe and other eiditors. With Notpad++ it is
 * possible to view it correctly.
 *
...
public class BookGenerator_ar extends BookGenerator {
  ...
  void start(File file) throws Exception {
    // because the arabic dictionary is so small we scan also the english dictionary for arabic
    // words
