...
public class BookGenerator_es extends BookGenerator {
  ...
  boolean isValidLanguage(String word, String wikiText) {
    ...
    // the follow rules can be found at
    // http://es.wiktionary.org/wiki/Categor%C3%ADa:ES:Plantillas_de_flexi%C3%B3n
    ...
    findRuleAndAddWords(
        ...
        "inflect.es.adj.-ón",
        null,
        new String[] {"ón", "ona", "ones", "onas"}); // redirect to inflect.es.adj.agudo-cons
    findRuleAndAddWords(
        word,
        wikiText,
        "inflect.es.adj.agudo-cons",
        null,
        new String[] {"ón", "ona", "ones", "onas"});
    findRuleAndAddWords(
        word,
        wikiText,
    ...
    findRuleAndAddWords(
        word, wikiText, "inflect.es.adj.reg", null, new String[] {"o", "os", "a", "as"});
    ...
    findRuleAndAddWords(
        ...
        "inflect.es.sust.-ón",
        null,
        new String[] {"ón", "ones"}); // redirect to inflect.es.sust.agudo-cons
    findRuleAndAddWords(
        word, wikiText, "inflect.es.sust.agudo-cons", null, new String[] {"ón", "ones"});
    ...
    findRuleAndAddWords(
        ...
        null,
        new String[] {
          "ar", "ado", "ando", "o", "as", "ás", "a", "amos", "áis", "an", "aba", "abas", "ábamos",
          "abais", "aban", "é", "aste", "ó", "asteis", "aron", "aré", "arás", "ará", "aremos",
          "aréis", "arán", "aría", "arías", "aríamos", "aríais", "arían", "e", "es", "és", "emos",
          "éis", "en", "ara", "aras", "áramos", "arais", "aran", "ase", "ases", "ásemos", "aseis",
          "asen", "are", "ares", "áremos", "areis", "aren", "á", "emos", "ad"
        });
    findRuleAndAddWords(
        word,
        wikiText,
        ...
        null,
        new String[] {
          "ar", "ado", "ando", "ás", "amos", "áis", "aba", "abas", "ábamos", "abais", "aban", "é",
          "aste", "ó", "asteis", "aron", "aré", "arás", "ará", "aremos", "aréis", "arán", "aría",
          "arías", "aríamos", "aríais", "arían", "és", "emos", "éis", "ara", "aras", "áramos",
          "arais", "aran", "ase", "ases", "ásemos", "aseis", "asen", "are", "ares", "áremos",
          "areis", "aren", "á", "emos", "ad"
        },
        new String[] {"o", "as", "a", "an", "e", "es", "en"});
    findRuleAndAddWords(
        word,
        wikiText,
        "es.v.conj.car",
  ...
  private void es_v_conj_ie_ue_er(String wikiText) {
    ...
    if (props != null) {
      ...
      props.setProperty(
          "im.2s",
          pronominal ? (props.getProperty("3", "{{{3}}}") + nexo + "ete") : (w2 + nexo + "e"));
  ...
  private void findRuleAndAddWords(
      String word, String wikiText, String rule, String[] endingName, String[] ending1) {
